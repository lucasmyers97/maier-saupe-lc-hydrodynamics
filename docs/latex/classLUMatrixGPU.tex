...
\+\_\+\+\_\+host\+\_\+\+\_\+ \+\_\+\+\_\+device\+\_\+\+\_\+ void \mbox{\hyperlink{classLUMatrixGPU_a50c1e29d76ba331a2eec20035fecf6ee}{solve}} (T $\ast$x)
...
\begin{DoxyCompactItemize}
\item 
T \mbox{\hyperlink{classLUMatrixGPU_a58da767ffad4982eee4f63eb9f8c825c}{A}} \mbox{[}N $\ast$N\mbox{]} = \{\}
\begin{DoxyCompactList}\small\item\em Array holding the matrix entries. \end{DoxyCompactList}\item 
unsigned int \mbox{\hyperlink{classLUMatrixGPU_ac9a00637063213d2f5550b8c981095c5}{row\+\_\+index}} \mbox{[}N\mbox{]} = \{\}
...
\DoxyCodeLine{}
\DoxyCodeLine{constexpr \textcolor{keywordtype}{int} N = 5;}
\DoxyCodeLine{}
\DoxyCodeLine{    \textcolor{comment}{// Generate an empty LUMatrixGPU object, populate randomly}}
\DoxyCodeLine{ \mbox{\hyperlink{classLUMatrixGPU}{LUMatrixGPU<double, N>}} lu\_mat;}
\DoxyCodeLine{ \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} i = 0; i < N; ++i)}
\DoxyCodeLine{    \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} j = 0; j < N; ++j)}
\DoxyCodeLine{        lu\_mat(i, j) = rand() / double(RAND\_MAX);}
\DoxyCodeLine{}
\DoxyCodeLine{    \textcolor{comment}{// Generate right-\/hand-\/sides}}
\DoxyCodeLine{ \textcolor{keywordtype}{double} *b = \textcolor{keyword}{new} \textcolor{keywordtype}{double}[N];}
\DoxyCodeLine{ \textcolor{keywordflow}{for} (\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} i = 0; i < N; ++i)}
\DoxyCodeLine{ \{}
\DoxyCodeLine{        b[N*n + i] = rand() / double(RAND\_MAX);}
\DoxyCodeLine{    \}}
\DoxyCodeLine{}
\DoxyCodeLine{ lu\_mat.\mbox{\hyperlink{classLUMatrixGPU_aae8933c867ed02888f0eb6b38003cdf8}{compute\_lu\_factorization}}();}
\DoxyCodeLine{ lu\_mat.\mbox{\hyperlink{classLUMatrixGPU_a50c1e29d76ba331a2eec20035fecf6ee}{solve}}(b);}
\end{DoxyCode}
...
\+\_\+\+\_\+host\+\_\+\+\_\+ \+\_\+\+\_\+device\+\_\+\+\_\+ \mbox{\hyperlink{classLUMatrixGPU}{L\+U\+Matrix\+G\+PU}}$<$ T, N $>$\+::\mbox{\hyperlink{classLUMatrixGPU}{L\+U\+Matrix\+G\+PU}} (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
{\footnotesize\ttfamily template$<$typename T , unsigned int N$>$ \\
\+\_\+\+\_\+host\+\_\+\+\_\+ \+\_\+\+\_\+device\+\_\+\+\_\+ \mbox{\hyperlink{classLUMatrixGPU}{L\+U\+Matrix\+G\+PU}}$<$ T, N $>$\+::\mbox{\hyperlink{classLUMatrixGPU}{L\+U\+Matrix\+G\+PU}} (\begin{DoxyParamCaption}\item[{T $\ast$}]{input\+\_\+data }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
{\footnotesize\ttfamily template$<$typename T , unsigned int N$>$ \\
\+\_\+\+\_\+host\+\_\+\+\_\+ \+\_\+\+\_\+device\+\_\+\+\_\+ void \mbox{\hyperlink{classLUMatrixGPU}{L\+U\+Matrix\+G\+PU}}$<$ T, N $>$\+::compute\+\_\+lu\+\_\+factorization\hspace{0.3cm}{\ttfamily [inline]}}
...
{\footnotesize\ttfamily template$<$typename T , unsigned int N$>$ \\
\+\_\+\+\_\+host\+\_\+\+\_\+ \+\_\+\+\_\+device\+\_\+\+\_\+ void \mbox{\hyperlink{classLUMatrixGPU}{L\+U\+Matrix\+G\+PU}}$<$ T, N $>$\+::copy (\begin{DoxyParamCaption}\item[{T $\ast$}]{input\+\_\+data }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
{\footnotesize\ttfamily template$<$typename T , unsigned int N$>$ \\
\+\_\+\+\_\+host\+\_\+\+\_\+ \+\_\+\+\_\+device\+\_\+\+\_\+ T \& \mbox{\hyperlink{classLUMatrixGPU}{L\+U\+Matrix\+G\+PU}}$<$ T, N $>$\+::operator() (\begin{DoxyParamCaption}\item[{const unsigned int}]{i,  }\item[{const unsigned int}]{j }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
{\footnotesize\ttfamily template$<$typename T , unsigned int N$>$ \\
\+\_\+\+\_\+host\+\_\+\+\_\+ const \+\_\+\+\_\+device\+\_\+\+\_\+ T \& \mbox{\hyperlink{classLUMatrixGPU}{L\+U\+Matrix\+G\+PU}}$<$ T, N $>$\+::operator() (\begin{DoxyParamCaption}\item[{const unsigned int}]{i,  }\item[{const unsigned int}]{j }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}
...
{\footnotesize\ttfamily template$<$typename T , unsigned int N$>$ \\
\+\_\+\+\_\+host\+\_\+\+\_\+ \+\_\+\+\_\+device\+\_\+\+\_\+ void \mbox{\hyperlink{classLUMatrixGPU}{L\+U\+Matrix\+G\+PU}}$<$ T, N $>$\+::solve (\begin{DoxyParamCaption}\item[{T $\ast$}]{x }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
{\footnotesize\ttfamily template$<$typename T , unsigned int N$>$ \\
T \mbox{\hyperlink{classLUMatrixGPU}{L\+U\+Matrix\+G\+PU}}$<$ T, N $>$\+::A\mbox{[}N $\ast$N\mbox{]} = \{\}\hspace{0.3cm}{\ttfamily [private]}}
...
{\footnotesize\ttfamily template$<$typename T , unsigned int N$>$ \\
unsigned int \mbox{\hyperlink{classLUMatrixGPU}{L\+U\+Matrix\+G\+PU}}$<$ T, N $>$\+::row\+\_\+index\mbox{[}N\mbox{]} = \{\}\hspace{0.3cm}{\ttfamily [private]}}
