...
template <int dim>
void assemble_bE2(const dealii::DoFHandler<dim> &dof_handler,
                 const dealii::AffineConstraints<double> &constraints,
                 const LA::MPI::Vector &solution,
                 LA::MPI::Vector &system_rhs)
{
                ...
                for (unsigned int q = 0; q < n_face_q_points; ++q)
                {
                    for (unsigned int i = 0; i < dofs_per_cell; ++i)
                    {
                        ...
                        if (component_i == 0)
                            cell_rhs(i) +=
                                (
                                 ((fe_face_values.normal_vector(q)[0]*dQ[q][0][0] + fe_face_values.normal_vector(q)[1]*dQ[q][1][0] + fe_face_values.normal_vector(q)[2]*dQ[q][2][0])
                                  * fe_face_values.shape_value(i, q))
                                )
                                * fe_face_values.JxW(q);
                        else if (component_i == 1)
                            cell_rhs(i) +=
                                (
                                 ((fe_face_values.normal_vector(q)[0]*dQ[q][0][1] + fe_face_values.normal_vector(q)[0]*dQ[q][1][0] + fe_face_values.normal_vector(q)[1]*dQ[q][1][1] + fe_face_values.normal_vector(q)[1]*dQ[q][3][0] + fe_face_values.normal_vector(q)[2]*dQ[q][2][1] + fe_face_values.normal_vector(q)[2]*dQ[q][4][0])
                                  * fe_face_values.shape_value(i, q))
                                )
                                * fe_face_values.JxW(q);
                        else if (component_i == 2)
                            cell_rhs(i) +=
                                (
                                 ((fe_face_values.normal_vector(q)[0]*dQ[q][2][0] + fe_face_values.normal_vector(q)[1]*dQ[q][4][0] - fe_face_values.normal_vector(q)[2]*(dQ[q][0][0] + dQ[q][3][0]))
                                  * fe_face_values.shape_value(i, q))
                                )
                                * fe_face_values.JxW(q);
                        else if (component_i == 3)
                            cell_rhs(i) +=
                                (
                                 ((fe_face_values.normal_vector(q)[0]*dQ[q][1][1] + fe_face_values.normal_vector(q)[1]*dQ[q][3][1] + fe_face_values.normal_vector(q)[2]*dQ[q][4][1])
                                  * fe_face_values.shape_value(i, q))
                                )
                                * fe_face_values.JxW(q);
                        else if (component_i == 4)
                            cell_rhs(i) +=
                                (
                                 ((fe_face_values.normal_vector(q)[0]*dQ[q][2][1] + fe_face_values.normal_vector(q)[1]*dQ[q][4][1] - fe_face_values.normal_vector(q)[2]*(dQ[q][0][1] + dQ[q][3][1]))
                                  * fe_face_values.shape_value(i, q))
                                )
                                * fe_face_values.JxW(q);   
                    }
...
template <int dim>
void assemble_bE31(const dealii::DoFHandler<dim> &dof_handler,
                 const dealii::AffineConstraints<double> &constraints,
                 const LA::MPI::Vector &solution,
                 LA::MPI::Vector &system_rhs)
{
                ...
                for (unsigned int q = 0; q < n_face_q_points; ++q)
                {
                    for (unsigned int i = 0; i < dofs_per_cell; ++i)
                    {
                        ...
                        if (component_i == 0)
                            cell_rhs(i) +=
                                (
                                 ((2*fe_face_values.normal_vector(q)[0]*Q_vec[q][0]*dQ[q][0][0] + fe_face_values.normal_vector(q)[0]*Q_vec[q][0]*dQ[q][3][0] + 2*fe_face_values.normal_vector(q)[0]*Q_vec[q][1]*dQ[q][0][1] + fe_face_values.normal_vector(q)[0]*Q_vec[q][1]*dQ[q][3][1] + 2*fe_face_values.normal_vector(q)[1]*Q_vec[q][1]*dQ[q][0][0] + fe_face_values.normal_vector(q)[1]*Q_vec[q][1]*dQ[q][3][0] + 2*fe_face_values.normal_vector(q)[1]*Q_vec[q][3]*dQ[q][0][1] + fe_face_values.normal_vector(q)[1]*Q_vec[q][3]*dQ[q][3][1] + 2*fe_face_values.normal_vector(q)[2]*Q_vec[q][2]*dQ[q][0][0] + fe_face_values.normal_vector(q)[2]*Q_vec[q][2]*dQ[q][3][0] + 2*fe_face_values.normal_vector(q)[2]*Q_vec[q][4]*dQ[q][0][1] + fe_face_values.normal_vector(q)[2]*Q_vec[q][4]*dQ[q][3][1])
                                  * fe_face_values.shape_value(i, q))
                                )
                                * fe_face_values.JxW(q);
                        else if (component_i == 1)
                            cell_rhs(i) +=
                                (
                                 (2*(fe_face_values.normal_vector(q)[0]*(Q_vec[q][0]*dQ[q][1][0] + Q_vec[q][1]*dQ[q][1][1]) + fe_face_values.normal_vector(q)[1]*(Q_vec[q][1]*dQ[q][1][0] + Q_vec[q][3]*dQ[q][1][1]) + fe_face_values.normal_vector(q)[2]*(Q_vec[q][2]*dQ[q][1][0] + Q_vec[q][4]*dQ[q][1][1]))
                                  * fe_face_values.shape_value(i, q))
                                )
                                * fe_face_values.JxW(q);
                        else if (component_i == 2)
                            cell_rhs(i) +=
                                (
                                 (2*(fe_face_values.normal_vector(q)[0]*(Q_vec[q][0]*dQ[q][2][0] + Q_vec[q][1]*dQ[q][2][1]) + fe_face_values.normal_vector(q)[1]*(Q_vec[q][1]*dQ[q][2][0] + Q_vec[q][3]*dQ[q][2][1]) + fe_face_values.normal_vector(q)[2]*(Q_vec[q][2]*dQ[q][2][0] + Q_vec[q][4]*dQ[q][2][1]))
                                  * fe_face_values.shape_value(i, q))
                                )
                                * fe_face_values.JxW(q);
                        else if (component_i == 3)
                            cell_rhs(i) +=
                                (
                                 ((fe_face_values.normal_vector(q)[0]*Q_vec[q][0]*dQ[q][0][0] + 2*fe_face_values.normal_vector(q)[0]*Q_vec[q][0]*dQ[q][3][0] + fe_face_values.normal_vector(q)[0]*Q_vec[q][1]*dQ[q][0][1] + 2*fe_face_values.normal_vector(q)[0]*Q_vec[q][1]*dQ[q][3][1] + fe_face_values.normal_vector(q)[1]*Q_vec[q][1]*dQ[q][0][0] + 2*fe_face_values.normal_vector(q)[1]*Q_vec[q][1]*dQ[q][3][0] + fe_face_values.normal_vector(q)[1]*Q_vec[q][3]*dQ[q][0][1] + 2*fe_face_values.normal_vector(q)[1]*Q_vec[q][3]*dQ[q][3][1] + fe_face_values.normal_vector(q)[2]*Q_vec[q][2]*dQ[q][0][0] + 2*fe_face_values.normal_vector(q)[2]*Q_vec[q][2]*dQ[q][3][0] + fe_face_values.normal_vector(q)[2]*Q_vec[q][4]*dQ[q][0][1] + 2*fe_face_values.normal_vector(q)[2]*Q_vec[q][4]*dQ[q][3][1])
                                  * fe_face_values.shape_value(i, q))
                                )
                                * fe_face_values.JxW(q);
                        else if (component_i == 4)
                            cell_rhs(i) +=
                                (
                                 (2*(fe_face_values.normal_vector(q)[0]*(Q_vec[q][0]*dQ[q][4][0] + Q_vec[q][1]*dQ[q][4][1]) + fe_face_values.normal_vector(q)[1]*(Q_vec[q][1]*dQ[q][4][0] + Q_vec[q][3]*dQ[q][4][1]) + fe_face_values.normal_vector(q)[2]*(Q_vec[q][2]*dQ[q][4][0] + Q_vec[q][4]*dQ[q][4][1]))
                                  * fe_face_values.shape_value(i, q))
                                )
                                * fe_face_values.JxW(q);
                    }
...
int main(int ac, char* av[])
{
    try
    {
        ...
        bE2.reinit(dof_handler.locally_owned_dofs(), mpi_communicator);
        E31.reinit(dof_handler.locally_owned_dofs(), mpi_communicator);
        bE31.reinit(dof_handler.locally_owned_dofs(), mpi_communicator);
        ...
        assemble_bE2(dof_handler, constraints, solution, bE2);
        assemble_E31(dof_handler, constraints, solution, E31);
        assemble_bE31(dof_handler, constraints, solution, bE31);
