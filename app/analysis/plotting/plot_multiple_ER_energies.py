...
def get_commandline_args():
    ...
    data_filenames = [os.path.join(args.data_folder, data_filename) for data_filename in args.data_filenames]
    plot_filename = os.path.join(output_folder, args.plot_filename)

    return data_filenames, plot_filename, args.title, args.final_timestep, args.show_output



def main():

    data_filenames, plot_filename, title, final_timestep, show_output = get_commandline_args()
