...
\begin{equation}
    ...
    \end{multlined}
\end{equation}
First, to make notation simpler, we non-dimensionalize by taking a nondimensional length $\overline{x} = x / \xi$, and a nondimensional time $\overline{t} = t / \tau$ and introducing the following constants:
\begin{equation}
