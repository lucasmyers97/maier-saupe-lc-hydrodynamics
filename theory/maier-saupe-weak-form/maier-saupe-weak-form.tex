...
\begin{document}
	...
	\begin{split}
		...
		- 2 L_2 (\partial_k \partial_m Q_{km}) \right) \delta_{ij}
		\end{multlined} \\
		&= F \left(Q_{ij}, \partial_k Q_{ij}, \partial_l \partial_k Q_{ij}\right)
	\end{split}
	\end{equation}
	One can see that $F$ is both symmetric and traceless by virtue of $Q_{ij}$ being traceless and symmetric.
	...
	\begin{align}
		...
		F &\to \left[ \theta F^n + (1 - \theta) F^{n - 1} \right]
	\end{align}
