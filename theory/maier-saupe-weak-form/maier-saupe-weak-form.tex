...
\begin{document}
	...
	To get a time evolution equation for each of these degrees of freedom, we just take the negative variation of the free energy density $f$ with respect to each of them:
	\begin{equation}
	\begin{split}
		\partial_t Q_{i} = - \frac{\delta f}{\delta Q_{i}}
	\end{split}
	\end{equation}
	where here we are thinking of $Q$ as a vector of each of the independent parameters.
\end{document}