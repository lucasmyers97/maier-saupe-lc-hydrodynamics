...
if (NOT DEFINED pre_configure_dir)
    set(pre_configure_dir ${SRC_DIR}/Utilities)
endif ()

if (NOT DEFINED post_configure_dir)
    set(post_configure_dir ${SRC_DIR}/Utilities)
endif ()
...
function(CheckGitSetup)
    ...
    add_library(git_version SHARED ${SRC_DIR}/Utilities/git_version.cpp)
    target_include_directories(git_version PRIVATE ${SRC_DIR}/Utilities)
    target_include_directories(git_version PUBLIC ${SRC_DIR})
