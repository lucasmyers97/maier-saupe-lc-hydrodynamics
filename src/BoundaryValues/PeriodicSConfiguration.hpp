#ifndef PERIODIC_S_CONFIGURATION_HPP
#define PERIODIC_S_CONFIGURATION_HPP
...
template <int dim>
class PeriodicSConfiguration : public BoundaryValues<dim>
{
public:
    PeriodicSConfiguration(double k_ = 1,
                          double eps_ = 0.1,
                          double S_ = 0.6751);
...
BOOST_CLASS_EXPORT_KEY(PeriodicSConfiguration<2>)
BOOST_CLASS_EXPORT_KEY(PeriodicSConfiguration<3>)
