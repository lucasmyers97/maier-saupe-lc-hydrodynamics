                ...
                if (component_i == 0)
                    ...
                    cell_rhs(i) +=
                        (
                         ...
                         +
                         (-L3*dt*(theta*((dQ0[q][0][0] + dQ0[q][3][0])*(dQ0[q][0][1] + dQ0[q][3][1]) + dQ0[q][0][0]*dQ0[q][0][1] + 2*dQ0[q][1][0]*dQ0[q][1][1] + 2*dQ0[q][2][0]*dQ0[q][2][1] + dQ0[q][3][0]*dQ0[q][3][1] + 2*dQ0[q][4][0]*dQ0[q][4][1]) - (theta - 1)*((dQ[q][0][0] + dQ[q][3][0])*(dQ[q][0][1] + dQ[q][3][1]) + dQ[q][0][0]*dQ[q][0][1] + 2*dQ[q][1][0]*dQ[q][1][1] + 2*dQ[q][2][0]*dQ[q][2][1] + dQ[q][3][0]*dQ[q][3][1] + 2*dQ[q][4][0]*dQ[q][4][1]))
                          * fe_values.shape_value(i, q))
                        )
                        * fe_values.JxW(q);
                    ...
                    if (component_i == 0 && component_j == 0)
                        cell_matrix(i, j) +=
                                (
                                 ...
                                 +
                                 (-L3*dt*(theta 
                                  - 1)*((2*dQ[q][0][0] + dQ[q][3][0]) * fe_values.shape_grad(j, q)[0] 
                        ...
                        cell_matrix(i, j) +=
                                (
                                 ...
                                 +
                                 (-2*L3*dt*(theta 
                                  - 1)*(dQ[q][1][0] * fe_values.shape_grad(j, q)[0] 
                        ...
                        cell_matrix(i, j) +=
                                (
                                 ...
                                 +
                                 (L2*dt*(theta 
                                  - 1)*(fe_values.shape_grad(i, q)[0] * fe_values.shape_grad(j, q)[2] 
                                  - fe_values.shape_grad(i, q)[2] * fe_values.shape_grad(j, q)[0]))
                                 +
                                 (-L3*dt*(theta 
                                  - 1)*((dQ[q][0][0] + dQ[q][3][0]) * fe_values.shape_grad(i, q)[2] 
                                  + (dQ[q][0][2] + dQ[q][3][2]) * fe_values.shape_grad(i, q)[0] 
                                  + dQ[q][0][0] * fe_values.shape_grad(i, q)[2] 
                                  + dQ[q][0][2] * fe_values.shape_grad(i, q)[0])
                                  * fe_values.shape_value(j, q))
                                 +
                                 (-2*L3*dt*(theta 
                                  - 1)*(dQ[q][2][0] * fe_values.shape_grad(j, q)[0] 
                        ...
                        cell_matrix(i, j) +=
                                (
                                 ...
                                 +
                                 (-L2*dt*(theta 
                                  - 1) * fe_values.shape_grad(i, q)[2]*fe_values.shape_grad(j, q)[2])
                                 +
                                 (-L3*dt*(theta 
                                  - 1)*((Q_vec[q][0] * fe_values.shape_grad(j, q)[0] 
                                  + Q_vec[q][1] * fe_values.shape_grad(j, q)[1] 
                                 ...
                                 +
                                 (-L3*dt*(theta 
                                  - 1)*((dQ[q][0][0] + 2*dQ[q][3][0]) * fe_values.shape_grad(j, q)[0] 
                        ...
                        cell_matrix(i, j) +=
                                (
                                 ...
                                 +
                                 (-L2*dt*(1 
                                  - theta) * fe_values.shape_grad(i, q)[1]*fe_values.shape_grad(j, q)[2])
                                 +
                                 (-L3*dt*(theta 
                                  - 1)*((dQ[q][0][1] + dQ[q][3][1]) * fe_values.shape_grad(i, q)[2] 
                                  + (dQ[q][0][2] + dQ[q][3][2]) * fe_values.shape_grad(i, q)[1] 
                                  + dQ[q][0][1] * fe_values.shape_grad(i, q)[2] 
                                  + dQ[q][0][2] * fe_values.shape_grad(i, q)[1])
                                  * fe_values.shape_value(j, q))
                                 +
                                 (-2*L3*dt*(theta 
                                  - 1)*(dQ[q][4][0] * fe_values.shape_grad(j, q)[0] 
                        ...
                        cell_matrix(i, j) +=
                                (
                                 ...
                                 +
                                 (-2*L3*dt*(theta 
                                  - 1)*(dQ[q][1][0] * fe_values.shape_grad(i, q)[0] 
                        ...
                        cell_matrix(i, j) +=
                                (
                                 ...
                                 +
                                 (-2*L3*dt*(theta 
                                  - 1)*((-(Q_vec[q][0] + Q_vec[q][3]) * fe_values.shape_grad(j, q)[2] 
                                  + Q_vec[q][2] * fe_values.shape_grad(j, q)[0] 
                                  + Q_vec[q][4] * fe_values.shape_grad(j, q)[1])*fe_values.shape_grad(i, q)[2] 
                                  + (Q_vec[q][0] * fe_values.shape_grad(j, q)[0] 
                                  + Q_vec[q][1] * fe_values.shape_grad(j, q)[1] 
                        ...
                        cell_matrix(i, j) +=
                                (
                                 ...
                                 +
                                 (-L2*dt*(theta 
                                  - 1) * fe_values.shape_grad(i, q)[2]*fe_values.shape_grad(j, q)[1])
                                 +
                                 (-2*L3*dt*(theta 
                                  - 1)*(dQ[q][1][0] * fe_values.shape_grad(i, q)[2] 
                        ...
                        cell_matrix(i, j) +=
                                (
                                 ...
                                 +
                                 (-2*L3*dt*(theta 
                                  - 1)*(dQ[q][1][1] * fe_values.shape_grad(i, q)[1] 
                                  - dQ[q][1][2] * fe_values.shape_grad(i, q)[2])
                                  * fe_values.shape_value(j, q))
                                 +
                                 (-L3*dt*(theta 
                        ...
                        cell_matrix(i, j) +=
                                (
                                 ...
                                 +
                                 (-L2*dt*(theta 
                                  - 1) * fe_values.shape_grad(i, q)[2]*fe_values.shape_grad(j, q)[0])
                                 +
                                 (-2*L3*dt*(theta 
                                  - 1)*(dQ[q][1][1] * fe_values.shape_grad(i, q)[2] 
                        ...
                        cell_matrix(i, j) +=
                                (
                                 ...
                                 +
                                 (-2*L3*dt*(theta 
                                  - 1)*(dQ[q][2][0] * fe_values.shape_grad(i, q)[0] 
                                  - dQ[q][2][2] * fe_values.shape_grad(i, q)[2])
                                  * fe_values.shape_value(j, q))
                                 +
                                 (-L3*dt*(theta 
                                  - 1)*((2*dQ[q][0][0] + dQ[q][3][0]) * fe_values.shape_grad(j, q)[2] 
                        ...
                        cell_matrix(i, j) +=
                                (
                                 ...
                                 +
                                 (-L2*dt*(theta 
                                  - 1) * fe_values.shape_grad(i, q)[1]*fe_values.shape_grad(j, q)[2])
                                 +
                                 (-2*L3*dt*(theta 
                                  - 1)*(dQ[q][2][0] * fe_values.shape_grad(i, q)[1] 
                                  + dQ[q][2][1] * fe_values.shape_grad(i, q)[0])
                                 ...
                                 +
                                 (-2*L3*dt*(theta 
                                  - 1)*(dQ[q][1][0] * fe_values.shape_grad(j, q)[2] 
                        ...
                        cell_matrix(i, j) +=
                                (
                                 ...
                                 +
                                 (-2*L3*dt*(theta 
                                  - 1)*(dQ[q][2][0] * fe_values.shape_grad(j, q)[2] 
                        ...
                        cell_matrix(i, j) +=
                                (
                                 ...
                                 +
                                 (-L2*dt*(1 
                                  - theta) * fe_values.shape_grad(i, q)[2]*fe_values.shape_grad(j, q)[0])
                                 +
                                 (-2*L3*dt*(theta 
                                  - 1)*(dQ[q][2][1] * fe_values.shape_grad(i, q)[1] 
                                  - dQ[q][2][2] * fe_values.shape_grad(i, q)[2])
                                  * fe_values.shape_value(j, q))
                                 +
                                 (-L3*dt*(theta 
                                  - 1)*((dQ[q][0][0] + 2*dQ[q][3][0]) * fe_values.shape_grad(j, q)[2] 
                        ...
                        cell_matrix(i, j) +=
                                (
                                 ...
                                 +
                                 (-2*L3*dt*(theta 
                                  - 1)*(dQ[q][2][1] * fe_values.shape_grad(i, q)[2] 
                                  + dQ[q][2][2] * fe_values.shape_grad(i, q)[1])
                                  * fe_values.shape_value(j, q))
                                 +
                                 (-2*L3*dt*(theta 
                                  - 1)*(dQ[q][4][0] * fe_values.shape_grad(j, q)[2] 
                        ...
                        cell_matrix(i, j) +=
                                (
                                 ...
                                 +
                                 (-L3*dt*(theta 
                                  - 1)*((2*dQ[q][0][1] + dQ[q][3][1]) * fe_values.shape_grad(j, q)[1] 
                                  - (2*dQ[q][0][2] + dQ[q][3][2]) * fe_values.shape_grad(j, q)[2])
                                  * fe_values.shape_value(i, q))
                                )
                                * fe_values.JxW(q);
                        ...
                        cell_matrix(i, j) +=
                                (
                                 ...
                                 (-2*L3*dt*(theta 
                                  - 1)*(dQ[q][1][1] * fe_values.shape_grad(j, q)[1] 
                                  - dQ[q][1][2] * fe_values.shape_grad(j, q)[2])
                                  * fe_values.shape_value(i, q))
                                )
                                * fe_values.JxW(q);
                        ...
                        cell_matrix(i, j) +=
                                (
                                 ...
                                 +
                                 (-L2*dt*(1 
                                  - theta) * fe_values.shape_grad(i, q)[0]*fe_values.shape_grad(j, q)[2])
                                 +
                                 (-L3*dt*(theta 
                                  - 1)*((dQ[q][0][0] + dQ[q][3][0]) * fe_values.shape_grad(i, q)[2] 
                                  + (dQ[q][0][2] + dQ[q][3][2]) * fe_values.shape_grad(i, q)[0] 
                                 ...
                                 +
                                 (-2*L3*dt*(theta 
                                  - 1)*(dQ[q][2][1] * fe_values.shape_grad(j, q)[1] 
                                  - dQ[q][2][2] * fe_values.shape_grad(j, q)[2])
                                  * fe_values.shape_value(i, q))
                                )
                                * fe_values.JxW(q);
                        ...
                        cell_matrix(i, j) +=
                                (
                                 ...
                                 +
                                 (-L3*dt*(theta 
                                  - 1)*((dQ[q][0][1] + 2*dQ[q][3][1]) * fe_values.shape_grad(j, q)[1] 
                                  - (dQ[q][0][2] + 2*dQ[q][3][2]) * fe_values.shape_grad(j, q)[2])
                                  * fe_values.shape_value(i, q))
                                )
                                * fe_values.JxW(q);
                        ...
                        cell_matrix(i, j) +=
                                (
                                 ...
                                 +
                                 (-2*L3*dt*(theta 
                                  - 1)*(dQ[q][4][1] * fe_values.shape_grad(j, q)[1] 
                                  - dQ[q][4][2] * fe_values.shape_grad(j, q)[2])
                                  * fe_values.shape_value(i, q))
                                )
                                * fe_values.JxW(q);
                        ...
                        cell_matrix(i, j) +=
                                (
                                 ...
                                 +
                                 (-L2*dt*(1 
                                  - theta) * fe_values.shape_grad(i, q)[2]*fe_values.shape_grad(j, q)[1])
                                 +
                                 (-2*L3*dt*(theta 
                                  - 1)*(dQ[q][4][0] * fe_values.shape_grad(i, q)[0] 
                                  - dQ[q][4][2] * fe_values.shape_grad(i, q)[2])
                                  * fe_values.shape_value(j, q))
                                 +
                                 (-L3*dt*(theta 
                                  - 1)*((2*dQ[q][0][1] + dQ[q][3][1]) * fe_values.shape_grad(j, q)[2] 
                        ...
                        cell_matrix(i, j) +=
                                (
                                 ...
                                 +
                                 (-2*L3*dt*(theta 
                                  - 1)*(dQ[q][1][1] * fe_values.shape_grad(j, q)[2] 
                        ...
                        cell_matrix(i, j) +=
                                (
                                 ...
                                 +
                                 (-2*L3*dt*(theta 
                                  - 1)*(dQ[q][4][0] * fe_values.shape_grad(i, q)[2] 
                                  + dQ[q][4][2] * fe_values.shape_grad(i, q)[0])
                                  * fe_values.shape_value(j, q))
                                 +
                                 (-2*L3*dt*(theta 
                                  - 1)*(dQ[q][2][1] * fe_values.shape_grad(j, q)[2] 
                        ...
                        cell_matrix(i, j) +=
                                (
                                 ...
                                 +
                                 (-2*L3*dt*(theta 
                                  - 1)*(dQ[q][4][1] * fe_values.shape_grad(i, q)[1] 
                                  - dQ[q][4][2] * fe_values.shape_grad(i, q)[2])
                                  * fe_values.shape_value(j, q))
                                 +
                                 (-L3*dt*(theta 
                                  - 1)*((dQ[q][0][1] + 2*dQ[q][3][1]) * fe_values.shape_grad(j, q)[2] 
                        ...
                        cell_matrix(i, j) +=
                                (
                                 ...
                                 +
                                 (-2*L3*dt*(theta 
                                  - 1)*(dQ[q][4][1] * fe_values.shape_grad(j, q)[2] 
                    ...
                    cell_rhs(i) +=
                        (
                         ...
                         (-dt*((theta*(dQ0[q][0][0] 
                          + dQ0[q][3][0]) - (theta - 1)*(dQ[q][0][0] + dQ[q][3][0])) * fe_values.shape_grad(i, q)[0] 
                          + (theta*(dQ0[q][0][1] + dQ0[q][3][1]) - (theta - 1)*(dQ[q][0][1] + dQ[q][3][1])) * fe_values.shape_grad(i, q)[1] 
                          + (theta*(dQ0[q][0][2] + dQ0[q][3][2]) - (theta - 1)*(dQ[q][0][2] + dQ[q][3][2])) * fe_values.shape_grad(i, q)[2] 
                          + (theta*dQ0[q][0][0] - (theta - 1)*dQ[q][0][0]) * fe_values.shape_grad(i, q)[0] 
                          + (theta*dQ0[q][0][1] - (theta - 1)*dQ[q][0][1]) * fe_values.shape_grad(i, q)[1] 
                          + (theta*dQ0[q][0][2] - (theta - 1)*dQ[q][0][2]) * fe_values.shape_grad(i, q)[2]))
                         +
                         (-L2*dt*((theta*(dQ0[q][0][2] 
                          + dQ0[q][3][2]) - (theta - 1)*(dQ[q][0][2] + dQ[q][3][2])) * fe_values.shape_grad(i, q)[2] 
                          + (theta*dQ0[q][0][0] - (theta - 1)*dQ[q][0][0]) * fe_values.shape_grad(i, q)[0] 
                          + (theta*dQ0[q][1][0] - (theta - 1)*dQ[q][1][0]) * fe_values.shape_grad(i, q)[1] 
                          + (theta*dQ0[q][2][0] - (theta - 1)*dQ[q][2][0]) * fe_values.shape_grad(i, q)[2] 
                          - (theta*dQ0[q][2][2] - (theta - 1)*dQ[q][2][2]) * fe_values.shape_grad(i, q)[0] 
                          - (theta*dQ0[q][4][2] - (theta - 1)*dQ[q][4][2]) * fe_values.shape_grad(i, q)[1]))
                         +
                         (-L3*dt*(
                          - (theta*(Q0_vec[q][0] + Q0_vec[q][3])*(dQ0[q][0][2] + dQ0[q][3][2]) - theta*(dQ0[q][0][0] + dQ0[q][3][0])*Q0_vec[q][2] - theta*(dQ0[q][0][1] + dQ0[q][3][1])*Q0_vec[q][4] - (theta - 1)*(Q_vec[q][0] + Q_vec[q][3])*(dQ[q][0][2] + dQ[q][3][2]) + (theta - 1)*(dQ[q][0][0] + dQ[q][3][0])*Q_vec[q][2] + (theta - 1)*(dQ[q][0][1] + dQ[q][3][1])*Q_vec[q][4]) * fe_values.shape_grad(i, q)[2] 
                          - (theta*(Q0_vec[q][0] + Q0_vec[q][3])*dQ0[q][0][2] - theta*Q0_vec[q][2]*dQ0[q][0][0] - theta*Q0_vec[q][4]*dQ0[q][0][1] - (theta - 1)*(Q_vec[q][0] + Q_vec[q][3])*dQ[q][0][2] + (theta - 1)*Q_vec[q][2]*dQ[q][0][0] + (theta - 1)*Q_vec[q][4]*dQ[q][0][1]) * fe_values.shape_grad(i, q)[2] 
                          + (theta*(dQ0[q][0][0] + dQ0[q][3][0])*Q0_vec[q][0] + theta*(dQ0[q][0][1] + dQ0[q][3][1])*Q0_vec[q][1] + theta*(dQ0[q][0][2] + dQ0[q][3][2])*Q0_vec[q][2] - (theta - 1)*(dQ[q][0][0] + dQ[q][3][0])*Q_vec[q][0] - (theta - 1)*(dQ[q][0][1] + dQ[q][3][1])*Q_vec[q][1] - (theta - 1)*(dQ[q][0][2] + dQ[q][3][2])*Q_vec[q][2]) * fe_values.shape_grad(i, q)[0] 
                          + (theta*(dQ0[q][0][0] + dQ0[q][3][0])*Q0_vec[q][1] + theta*(dQ0[q][0][1] + dQ0[q][3][1])*Q0_vec[q][3] + theta*(dQ0[q][0][2] + dQ0[q][3][2])*Q0_vec[q][4] - (theta - 1)*(dQ[q][0][0] + dQ[q][3][0])*Q_vec[q][1] - (theta - 1)*(dQ[q][0][1] + dQ[q][3][1])*Q_vec[q][3] - (theta - 1)*(dQ[q][0][2] + dQ[q][3][2])*Q_vec[q][4]) * fe_values.shape_grad(i, q)[1] 
                          + (theta*Q0_vec[q][0]*dQ0[q][0][0] + theta*Q0_vec[q][1]*dQ0[q][0][1] + theta*Q0_vec[q][2]*dQ0[q][0][2] - (theta - 1)*Q_vec[q][0]*dQ[q][0][0] - (theta - 1)*Q_vec[q][1]*dQ[q][0][1] - (theta - 1)*Q_vec[q][2]*dQ[q][0][2]) * fe_values.shape_grad(i, q)[0] 
                          + (theta*Q0_vec[q][1]*dQ0[q][0][0] + theta*Q0_vec[q][3]*dQ0[q][0][1] + theta*Q0_vec[q][4]*dQ0[q][0][2] - (theta - 1)*Q_vec[q][1]*dQ[q][0][0] - (theta - 1)*Q_vec[q][3]*dQ[q][0][1] - (theta - 1)*Q_vec[q][4]*dQ[q][0][2]) * fe_values.shape_grad(i, q)[1]))
                         +
                         ((1.0/2.0)*L3*dt*(theta*(-(dQ0[q][0][0] + dQ0[q][3][0])*dQ0[q][2][2] - (dQ0[q][0][1] + dQ0[q][3][1])*dQ0[q][4][2] + (dQ0[q][0][2] + dQ0[q][3][2]) * (dQ0[q][0][2] + dQ0[q][3][2]) + dQ0[q][0][2]*dQ0[q][2][0] + dQ0[q][1][2]*dQ0[q][2][1] + dQ0[q][1][2]*dQ0[q][4][0] + (dQ0[q][2][2]) * (dQ0[q][2][2]) + dQ0[q][3][2]*dQ0[q][4][1] + (dQ0[q][4][2]) * (dQ0[q][4][2])) - theta*(-(dQ0[q][0][0] + dQ0[q][3][0])*dQ0[q][2][2] + (dQ0[q][0][0]) * (dQ0[q][0][0]) + dQ0[q][0][1]*dQ0[q][1][0] + dQ0[q][0][2]*dQ0[q][2][0] + (dQ0[q][1][0]) * (dQ0[q][1][0]) + dQ0[q][1][1]*dQ0[q][3][0] + dQ0[q][1][2]*dQ0[q][4][0] + (dQ0[q][2][0]) * (dQ0[q][2][0]) + dQ0[q][2][1]*dQ0[q][4][0]) - (theta - 1)*(-(dQ[q][0][0] + dQ[q][3][0])*dQ[q][2][2] - (dQ[q][0][1] + dQ[q][3][1])*dQ[q][4][2] + (dQ[q][0][2] + dQ[q][3][2]) * (dQ[q][0][2] + dQ[q][3][2]) + dQ[q][0][2]*dQ[q][2][0] + dQ[q][1][2]*dQ[q][2][1] + dQ[q][1][2]*dQ[q][4][0] + (dQ[q][2][2]) * (dQ[q][2][2]) + dQ[q][3][2]*dQ[q][4][1] + (dQ[q][4][2]) * (dQ[q][4][2])) + (theta - 1)*(-(dQ[q][0][0] + dQ[q][3][0])*dQ[q][2][2] + (dQ[q][0][0]) * (dQ[q][0][0]) + dQ[q][0][1]*dQ[q][1][0] + dQ[q][0][2]*dQ[q][2][0] + (dQ[q][1][0]) * (dQ[q][1][0]) + dQ[q][1][1]*dQ[q][3][0] + dQ[q][1][2]*dQ[q][4][0] + (dQ[q][2][0]) * (dQ[q][2][0]) + dQ[q][2][1]*dQ[q][4][0]))
                          * fe_values.shape_value(i, q))
                        )
                        * fe_values.JxW(q);
                else if (component_i == 1)
                    cell_rhs(i) +=
                        (
                         ...
                         (-2*dt*((theta*dQ0[q][1][0] 
                          - (theta - 1)*dQ[q][1][0]) * fe_values.shape_grad(i, q)[0] 
                          + (theta*dQ0[q][1][1] - (theta - 1)*dQ[q][1][1]) * fe_values.shape_grad(i, q)[1] 
                          + (theta*dQ0[q][1][2] - (theta - 1)*dQ[q][1][2]) * fe_values.shape_grad(i, q)[2]))
                         +
                         (-L2*dt*((theta*dQ0[q][0][1] 
                          - (theta - 1)*dQ[q][0][1]) * fe_values.shape_grad(i, q)[0] 
                          + (theta*dQ0[q][1][0] - (theta - 1)*dQ[q][1][0]) * fe_values.shape_grad(i, q)[0] 
                          + (theta*dQ0[q][1][1] - (theta - 1)*dQ[q][1][1]) * fe_values.shape_grad(i, q)[1] 
                          + (theta*dQ0[q][2][1] - (theta - 1)*dQ[q][2][1]) * fe_values.shape_grad(i, q)[2] 
                          + (theta*dQ0[q][3][0] - (theta - 1)*dQ[q][3][0]) * fe_values.shape_grad(i, q)[1] 
                          + (theta*dQ0[q][4][0] - (theta - 1)*dQ[q][4][0]) * fe_values.shape_grad(i, q)[2]))
                         +
                         (-2*L3*dt*(
                          - (theta*(Q0_vec[q][0] + Q0_vec[q][3])*dQ0[q][1][2] - theta*Q0_vec[q][2]*dQ0[q][1][0] - theta*Q0_vec[q][4]*dQ0[q][1][1] - (theta - 1)*(Q_vec[q][0] + Q_vec[q][3])*dQ[q][1][2] + (theta - 1)*Q_vec[q][2]*dQ[q][1][0] + (theta - 1)*Q_vec[q][4]*dQ[q][1][1]) * fe_values.shape_grad(i, q)[2] 
                          + (theta*Q0_vec[q][0]*dQ0[q][1][0] + theta*Q0_vec[q][1]*dQ0[q][1][1] + theta*Q0_vec[q][2]*dQ0[q][1][2] - (theta - 1)*Q_vec[q][0]*dQ[q][1][0] - (theta - 1)*Q_vec[q][1]*dQ[q][1][1] - (theta - 1)*Q_vec[q][2]*dQ[q][1][2]) * fe_values.shape_grad(i, q)[0] 
                          + (theta*Q0_vec[q][1]*dQ0[q][1][0] + theta*Q0_vec[q][3]*dQ0[q][1][1] + theta*Q0_vec[q][4]*dQ0[q][1][2] - (theta - 1)*Q_vec[q][1]*dQ[q][1][0] - (theta - 1)*Q_vec[q][3]*dQ[q][1][1] - (theta - 1)*Q_vec[q][4]*dQ[q][1][2]) * fe_values.shape_grad(i, q)[1]))
                         +
                         (-1.0/2.0*L3*dt*(theta*(-(dQ0[q][0][0] + dQ0[q][3][0])*dQ0[q][4][2] + dQ0[q][0][0]*dQ0[q][1][0] + dQ0[q][1][0]*dQ0[q][1][1] + dQ0[q][1][0]*dQ0[q][3][0] + dQ0[q][1][2]*dQ0[q][2][0] + dQ0[q][2][0]*dQ0[q][4][0] + dQ0[q][3][0]*dQ0[q][3][1] + dQ0[q][3][2]*dQ0[q][4][0] + dQ0[q][4][0]*dQ0[q][4][1]) + theta*(-(dQ0[q][0][1] + dQ0[q][3][1])*dQ0[q][2][2] + dQ0[q][0][0]*dQ0[q][0][1] + dQ0[q][0][1]*dQ0[q][1][1] + dQ0[q][0][2]*dQ0[q][2][1] + dQ0[q][1][0]*dQ0[q][1][1] + dQ0[q][1][1]*dQ0[q][3][1] + dQ0[q][1][2]*dQ0[q][4][1] + dQ0[q][2][0]*dQ0[q][2][1] + dQ0[q][2][1]*dQ0[q][4][1]) - (theta - 1)*(-(dQ[q][0][0] + dQ[q][3][0])*dQ[q][4][2] + dQ[q][0][0]*dQ[q][1][0] + dQ[q][1][0]*dQ[q][1][1] + dQ[q][1][0]*dQ[q][3][0] + dQ[q][1][2]*dQ[q][2][0] + dQ[q][2][0]*dQ[q][4][0] + dQ[q][3][0]*dQ[q][3][1] + dQ[q][3][2]*dQ[q][4][0] + dQ[q][4][0]*dQ[q][4][1]) - (theta - 1)*(-(dQ[q][0][1] + dQ[q][3][1])*dQ[q][2][2] + dQ[q][0][0]*dQ[q][0][1] + dQ[q][0][1]*dQ[q][1][1] + dQ[q][0][2]*dQ[q][2][1] + dQ[q][1][0]*dQ[q][1][1] + dQ[q][1][1]*dQ[q][3][1] + dQ[q][1][2]*dQ[q][4][1] + dQ[q][2][0]*dQ[q][2][1] + dQ[q][2][1]*dQ[q][4][1]))
                          * fe_values.shape_value(i, q))
                        )
                        * fe_values.JxW(q);
                else if (component_i == 2)
                    cell_rhs(i) +=
                        (
                         ...
                         (-2*dt*((theta*dQ0[q][2][0] 
                          - (theta - 1)*dQ[q][2][0]) * fe_values.shape_grad(i, q)[0] 
                          + (theta*dQ0[q][2][1] - (theta - 1)*dQ[q][2][1]) * fe_values.shape_grad(i, q)[1] 
                          + (theta*dQ0[q][2][2] - (theta - 1)*dQ[q][2][2]) * fe_values.shape_grad(i, q)[2]))
                         +
                
                         (-L2*dt*(
                          - (theta*(dQ0[q][0][0] + dQ0[q][3][0]) - (theta - 1)*(dQ[q][0][0] + dQ[q][3][0])) * fe_values.shape_grad(i, q)[2] 
                          + (theta*dQ0[q][0][2] - (theta - 1)*dQ[q][0][2]) * fe_values.shape_grad(i, q)[0] 
                          + (theta*dQ0[q][1][2] - (theta - 1)*dQ[q][1][2]) * fe_values.shape_grad(i, q)[1] 
                          + (theta*dQ0[q][2][0] - (theta - 1)*dQ[q][2][0]) * fe_values.shape_grad(i, q)[0] 
                          + (theta*dQ0[q][2][2] - (theta - 1)*dQ[q][2][2]) * fe_values.shape_grad(i, q)[2] 
                          + (theta*dQ0[q][4][0] - (theta - 1)*dQ[q][4][0]) * fe_values.shape_grad(i, q)[1]))
                         +
                         (-2*L3*dt*(
                          - (theta*(Q0_vec[q][0] + Q0_vec[q][3])*dQ0[q][2][2] - theta*Q0_vec[q][2]*dQ0[q][2][0] - theta*Q0_vec[q][4]*dQ0[q][2][1] - (theta - 1)*(Q_vec[q][0] + Q_vec[q][3])*dQ[q][2][2] + (theta - 1)*Q_vec[q][2]*dQ[q][2][0] + (theta - 1)*Q_vec[q][4]*dQ[q][2][1]) * fe_values.shape_grad(i, q)[2] 
                          + (theta*Q0_vec[q][0]*dQ0[q][2][0] + theta*Q0_vec[q][1]*dQ0[q][2][1] + theta*Q0_vec[q][2]*dQ0[q][2][2] - (theta - 1)*Q_vec[q][0]*dQ[q][2][0] - (theta - 1)*Q_vec[q][1]*dQ[q][2][1] - (theta - 1)*Q_vec[q][2]*dQ[q][2][2]) * fe_values.shape_grad(i, q)[0] 
                          + (theta*Q0_vec[q][1]*dQ0[q][2][0] + theta*Q0_vec[q][3]*dQ0[q][2][1] + theta*Q0_vec[q][4]*dQ0[q][2][2] - (theta - 1)*Q_vec[q][1]*dQ[q][2][0] - (theta - 1)*Q_vec[q][3]*dQ[q][2][1] - (theta - 1)*Q_vec[q][4]*dQ[q][2][2]) * fe_values.shape_grad(i, q)[1]))
                         +
                         (-1.0/2.0*L3*dt*(theta*((dQ0[q][0][0] + dQ0[q][3][0])*(dQ0[q][0][2] + dQ0[q][3][2]) - (dQ0[q][0][0] + dQ0[q][3][0])*dQ0[q][2][0] - (dQ0[q][0][1] + dQ0[q][3][1])*dQ0[q][4][0] + dQ0[q][0][0]*dQ0[q][2][0] + dQ0[q][1][0]*dQ0[q][2][1] + dQ0[q][1][0]*dQ0[q][4][0] + dQ0[q][2][0]*dQ0[q][2][2] + dQ0[q][3][0]*dQ0[q][4][1] + dQ0[q][4][0]*dQ0[q][4][2]) + theta*(-(dQ0[q][0][2] + dQ0[q][3][2])*dQ0[q][2][2] + dQ0[q][0][0]*dQ0[q][0][2] + dQ0[q][0][1]*dQ0[q][1][2] + dQ0[q][0][2]*dQ0[q][2][2] + dQ0[q][1][0]*dQ0[q][1][2] + dQ0[q][1][1]*dQ0[q][3][2] + dQ0[q][1][2]*dQ0[q][4][2] + dQ0[q][2][0]*dQ0[q][2][2] + dQ0[q][2][1]*dQ0[q][4][2]) - (theta - 1)*((dQ[q][0][0] + dQ[q][3][0])*(dQ[q][0][2] + dQ[q][3][2]) - (dQ[q][0][0] + dQ[q][3][0])*dQ[q][2][0] - (dQ[q][0][1] + dQ[q][3][1])*dQ[q][4][0] + dQ[q][0][0]*dQ[q][2][0] + dQ[q][1][0]*dQ[q][2][1] + dQ[q][1][0]*dQ[q][4][0] + dQ[q][2][0]*dQ[q][2][2] + dQ[q][3][0]*dQ[q][4][1] + dQ[q][4][0]*dQ[q][4][2]) - (theta - 1)*(-(dQ[q][0][2] + dQ[q][3][2])*dQ[q][2][2] + dQ[q][0][0]*dQ[q][0][2] + dQ[q][0][1]*dQ[q][1][2] + dQ[q][0][2]*dQ[q][2][2] + dQ[q][1][0]*dQ[q][1][2] + dQ[q][1][1]*dQ[q][3][2] + dQ[q][1][2]*dQ[q][4][2] + dQ[q][2][0]*dQ[q][2][2] + dQ[q][2][1]*dQ[q][4][2]))
                          * fe_values.shape_value(i, q))
                        )
                        * fe_values.JxW(q);
                else if (component_i == 3)
                    cell_rhs(i) +=
                        (
                         ...
                         (-dt*((theta*(dQ0[q][0][0] 
                          ...
                          + (theta*dQ0[q][3][0] - (theta - 1)*dQ[q][3][0]) * fe_values.shape_grad(i, q)[0] 
                          + (theta*dQ0[q][3][1] - (theta - 1)*dQ[q][3][1]) * fe_values.shape_grad(i, q)[1] 
                          + (theta*dQ0[q][3][2] - (theta - 1)*dQ[q][3][2]) * fe_values.shape_grad(i, q)[2]))
                         +
                         (-L2*dt*((theta*(dQ0[q][0][2] 
                          + dQ0[q][3][2]) - (theta - 1)*(dQ[q][0][2] + dQ[q][3][2])) * fe_values.shape_grad(i, q)[2] 
                          + (theta*dQ0[q][1][1] - (theta - 1)*dQ[q][1][1]) * fe_values.shape_grad(i, q)[0] 
                          - (theta*dQ0[q][2][2] - (theta - 1)*dQ[q][2][2]) * fe_values.shape_grad(i, q)[0] 
                          + (theta*dQ0[q][3][1] - (theta - 1)*dQ[q][3][1]) * fe_values.shape_grad(i, q)[1] 
                          + (theta*dQ0[q][4][1] - (theta - 1)*dQ[q][4][1]) * fe_values.shape_grad(i, q)[2] 
                          - (theta*dQ0[q][4][2] - (theta - 1)*dQ[q][4][2]) * fe_values.shape_grad(i, q)[1]))
                         +
                         (-L3*dt*(
                          - (theta*(Q0_vec[q][0] + Q0_vec[q][3])*(dQ0[q][0][2] + dQ0[q][3][2]) - theta*(dQ0[q][0][0] + dQ0[q][3][0])*Q0_vec[q][2] - theta*(dQ0[q][0][1] + dQ0[q][3][1])*Q0_vec[q][4] - (theta - 1)*(Q_vec[q][0] + Q_vec[q][3])*(dQ[q][0][2] + dQ[q][3][2]) + (theta - 1)*(dQ[q][0][0] + dQ[q][3][0])*Q_vec[q][2] + (theta - 1)*(dQ[q][0][1] + dQ[q][3][1])*Q_vec[q][4]) * fe_values.shape_grad(i, q)[2] 
                          - (theta*(Q0_vec[q][0] + Q0_vec[q][3])*dQ0[q][3][2] - theta*Q0_vec[q][2]*dQ0[q][3][0] - theta*Q0_vec[q][4]*dQ0[q][3][1] - (theta - 1)*(Q_vec[q][0] + Q_vec[q][3])*dQ[q][3][2] + (theta - 1)*Q_vec[q][2]*dQ[q][3][0] + (theta - 1)*Q_vec[q][4]*dQ[q][3][1]) * fe_values.shape_grad(i, q)[2] 
                          + (theta*(dQ0[q][0][0] + dQ0[q][3][0])*Q0_vec[q][0] + theta*(dQ0[q][0][1] + dQ0[q][3][1])*Q0_vec[q][1] + theta*(dQ0[q][0][2] + dQ0[q][3][2])*Q0_vec[q][2] - (theta - 1)*(dQ[q][0][0] + dQ[q][3][0])*Q_vec[q][0] - (theta - 1)*(dQ[q][0][1] + dQ[q][3][1])*Q_vec[q][1] - (theta - 1)*(dQ[q][0][2] + dQ[q][3][2])*Q_vec[q][2]) * fe_values.shape_grad(i, q)[0] 
                          + (theta*(dQ0[q][0][0] + dQ0[q][3][0])*Q0_vec[q][1] + theta*(dQ0[q][0][1] + dQ0[q][3][1])*Q0_vec[q][3] + theta*(dQ0[q][0][2] + dQ0[q][3][2])*Q0_vec[q][4] - (theta - 1)*(dQ[q][0][0] + dQ[q][3][0])*Q_vec[q][1] - (theta - 1)*(dQ[q][0][1] + dQ[q][3][1])*Q_vec[q][3] - (theta - 1)*(dQ[q][0][2] + dQ[q][3][2])*Q_vec[q][4]) * fe_values.shape_grad(i, q)[1] 
                          + (theta*Q0_vec[q][0]*dQ0[q][3][0] + theta*Q0_vec[q][1]*dQ0[q][3][1] + theta*Q0_vec[q][2]*dQ0[q][3][2] - (theta - 1)*Q_vec[q][0]*dQ[q][3][0] - (theta - 1)*Q_vec[q][1]*dQ[q][3][1] - (theta - 1)*Q_vec[q][2]*dQ[q][3][2]) * fe_values.shape_grad(i, q)[0] 
                          + (theta*Q0_vec[q][1]*dQ0[q][3][0] + theta*Q0_vec[q][3]*dQ0[q][3][1] + theta*Q0_vec[q][4]*dQ0[q][3][2] - (theta - 1)*Q_vec[q][1]*dQ[q][3][0] - (theta - 1)*Q_vec[q][3]*dQ[q][3][1] - (theta - 1)*Q_vec[q][4]*dQ[q][3][2]) * fe_values.shape_grad(i, q)[1]))
                         +
                         ((1.0/2.0)*L3*dt*(theta*(-(dQ0[q][0][0] + dQ0[q][3][0])*dQ0[q][2][2] - (dQ0[q][0][1] + dQ0[q][3][1])*dQ0[q][4][2] + (dQ0[q][0][2] + dQ0[q][3][2]) * (dQ0[q][0][2] + dQ0[q][3][2]) + dQ0[q][0][2]*dQ0[q][2][0] + dQ0[q][1][2]*dQ0[q][2][1] + dQ0[q][1][2]*dQ0[q][4][0] + (dQ0[q][2][2]) * (dQ0[q][2][2]) + dQ0[q][3][2]*dQ0[q][4][1] + (dQ0[q][4][2]) * (dQ0[q][4][2])) - theta*(-(dQ0[q][0][1] + dQ0[q][3][1])*dQ0[q][4][2] + dQ0[q][0][1]*dQ0[q][1][0] + (dQ0[q][1][1]) * (dQ0[q][1][1]) + dQ0[q][1][1]*dQ0[q][3][0] + dQ0[q][1][2]*dQ0[q][2][1] + dQ0[q][2][1]*dQ0[q][4][0] + (dQ0[q][3][1]) * (dQ0[q][3][1]) + dQ0[q][3][2]*dQ0[q][4][1] + (dQ0[q][4][1]) * (dQ0[q][4][1])) - (theta - 1)*(-(dQ[q][0][0] + dQ[q][3][0])*dQ[q][2][2] - (dQ[q][0][1] + dQ[q][3][1])*dQ[q][4][2] + (dQ[q][0][2] + dQ[q][3][2]) * (dQ[q][0][2] + dQ[q][3][2]) + dQ[q][0][2]*dQ[q][2][0] + dQ[q][1][2]*dQ[q][2][1] + dQ[q][1][2]*dQ[q][4][0] + (dQ[q][2][2]) * (dQ[q][2][2]) + dQ[q][3][2]*dQ[q][4][1] + (dQ[q][4][2]) * (dQ[q][4][2])) + (theta - 1)*(-(dQ[q][0][1] + dQ[q][3][1])*dQ[q][4][2] + dQ[q][0][1]*dQ[q][1][0] + (dQ[q][1][1]) * (dQ[q][1][1]) + dQ[q][1][1]*dQ[q][3][0] + dQ[q][1][2]*dQ[q][2][1] + dQ[q][2][1]*dQ[q][4][0] + (dQ[q][3][1]) * (dQ[q][3][1]) + dQ[q][3][2]*dQ[q][4][1] + (dQ[q][4][1]) * (dQ[q][4][1])))
                          * fe_values.shape_value(i, q))
                        )
                        * fe_values.JxW(q);
                else if (component_i == 4)
                    cell_rhs(i) +=
                        (
                         ...
                         (-2*dt*((theta*dQ0[q][4][0] 
                          - (theta - 1)*dQ[q][4][0]) * fe_values.shape_grad(i, q)[0] 
                          + (theta*dQ0[q][4][1] - (theta - 1)*dQ[q][4][1]) * fe_values.shape_grad(i, q)[1] 
                          + (theta*dQ0[q][4][2] - (theta - 1)*dQ[q][4][2]) * fe_values.shape_grad(i, q)[2]))
                         +
                         (-L2*dt*(
                          - (theta*(dQ0[q][0][1] + dQ0[q][3][1]) - (theta - 1)*(dQ[q][0][1] + dQ[q][3][1])) * fe_values.shape_grad(i, q)[2] 
                          + (theta*dQ0[q][1][2] - (theta - 1)*dQ[q][1][2]) * fe_values.shape_grad(i, q)[0] 
                          + (theta*dQ0[q][2][1] - (theta - 1)*dQ[q][2][1]) * fe_values.shape_grad(i, q)[0] 
                          + (theta*dQ0[q][3][2] - (theta - 1)*dQ[q][3][2]) * fe_values.shape_grad(i, q)[1] 
                          + (theta*dQ0[q][4][1] - (theta - 1)*dQ[q][4][1]) * fe_values.shape_grad(i, q)[1] 
                          + (theta*dQ0[q][4][2] - (theta - 1)*dQ[q][4][2]) * fe_values.shape_grad(i, q)[2]))
                         +
                         (-2*L3*dt*(
                          - (theta*(Q0_vec[q][0] + Q0_vec[q][3])*dQ0[q][4][2] - theta*Q0_vec[q][2]*dQ0[q][4][0] - theta*Q0_vec[q][4]*dQ0[q][4][1] - (theta - 1)*(Q_vec[q][0] + Q_vec[q][3])*dQ[q][4][2] + (theta - 1)*Q_vec[q][2]*dQ[q][4][0] + (theta - 1)*Q_vec[q][4]*dQ[q][4][1]) * fe_values.shape_grad(i, q)[2] 
                          + (theta*Q0_vec[q][0]*dQ0[q][4][0] + theta*Q0_vec[q][1]*dQ0[q][4][1] + theta*Q0_vec[q][2]*dQ0[q][4][2] - (theta - 1)*Q_vec[q][0]*dQ[q][4][0] - (theta - 1)*Q_vec[q][1]*dQ[q][4][1] - (theta - 1)*Q_vec[q][2]*dQ[q][4][2]) * fe_values.shape_grad(i, q)[0] 
                          + (theta*Q0_vec[q][1]*dQ0[q][4][0] + theta*Q0_vec[q][3]*dQ0[q][4][1] + theta*Q0_vec[q][4]*dQ0[q][4][2] - (theta - 1)*Q_vec[q][1]*dQ[q][4][0] - (theta - 1)*Q_vec[q][3]*dQ[q][4][1] - (theta - 1)*Q_vec[q][4]*dQ[q][4][2]) * fe_values.shape_grad(i, q)[1]))
                         +
                         (-1.0/2.0*L3*dt*(theta*(-(dQ0[q][0][0] + dQ0[q][3][0])*dQ0[q][2][1] + (dQ0[q][0][1] + dQ0[q][3][1])*(dQ0[q][0][2] + dQ0[q][3][2]) - (dQ0[q][0][1] + dQ0[q][3][1])*dQ0[q][4][1] + dQ0[q][0][1]*dQ0[q][2][0] + dQ0[q][1][1]*dQ0[q][2][1] + dQ0[q][1][1]*dQ0[q][4][0] + dQ0[q][2][1]*dQ0[q][2][2] + dQ0[q][3][1]*dQ0[q][4][1] + dQ0[q][4][1]*dQ0[q][4][2]) + theta*(-(dQ0[q][0][2] + dQ0[q][3][2])*dQ0[q][4][2] + dQ0[q][0][2]*dQ0[q][1][0] + dQ0[q][1][1]*dQ0[q][1][2] + dQ0[q][1][2]*dQ0[q][2][2] + dQ0[q][1][2]*dQ0[q][3][0] + dQ0[q][2][2]*dQ0[q][4][0] + dQ0[q][3][1]*dQ0[q][3][2] + dQ0[q][3][2]*dQ0[q][4][2] + dQ0[q][4][1]*dQ0[q][4][2]) - (theta - 1)*(-(dQ[q][0][0] + dQ[q][3][0])*dQ[q][2][1] + (dQ[q][0][1] + dQ[q][3][1])*(dQ[q][0][2] + dQ[q][3][2]) - (dQ[q][0][1] + dQ[q][3][1])*dQ[q][4][1] + dQ[q][0][1]*dQ[q][2][0] + dQ[q][1][1]*dQ[q][2][1] + dQ[q][1][1]*dQ[q][4][0] + dQ[q][2][1]*dQ[q][2][2] + dQ[q][3][1]*dQ[q][4][1] + dQ[q][4][1]*dQ[q][4][2]) - (theta - 1)*(-(dQ[q][0][2] + dQ[q][3][2])*dQ[q][4][2] + dQ[q][0][2]*dQ[q][1][0] + dQ[q][1][1]*dQ[q][1][2] + dQ[q][1][2]*dQ[q][2][2] + dQ[q][1][2]*dQ[q][3][0] + dQ[q][2][2]*dQ[q][4][0] + dQ[q][3][1]*dQ[q][3][2] + dQ[q][3][2]*dQ[q][4][2] + dQ[q][4][1]*dQ[q][4][2]))
                          * fe_values.shape_value(i, q))
                        )
                        * fe_values.JxW(q);
            }
