            ...
            for (unsigned int i = 0; i < dofs_per_cell; ++i)
            {
                ...
                for (unsigned int j = 0; j < dofs_per_cell; ++j)
                {
                    ...
                    if (component_i == 0 && component_j == 0)
                        cell_matrix(i, j) += (
                            ...
                            +
                            L3*(-2*Q_vec[q][0]*fe_values.shape_grad(i, q)[0]*fe_values.shape_grad(j, q)[0] - 2*Q_vec[q][1]*fe_values.shape_grad(i, q)[0]*fe_values.shape_grad(j, q)[1] - 2*Q_vec[q][1]*fe_values.shape_grad(i, q)[1]*fe_values.shape_grad(j, q)[0] - 2*Q_vec[q][3]*fe_values.shape_grad(i, q)[1]*fe_values.shape_grad(j, q)[1] - 2*fe_values.shape_value(j, q)*dQ[q][0][0]*fe_values.shape_grad(i, q)[0] - fe_values.shape_value(j, q)*dQ[q][3][0]*fe_values.shape_grad(i, q)[0])
                            ) * fe_values.JxW(q);
                        ...
                        cell_matrix(i, j) += (
                            ...
                            +
                            -2*L3*((Q_vec[q][0]*fe_values.shape_grad(j, q)[0] + Q_vec[q][1]*fe_values.shape_grad(j, q)[1] + fe_values.shape_value(j, q)*dQ[q][1][1])*fe_values.shape_grad(i, q)[0] + (Q_vec[q][1]*fe_values.shape_grad(j, q)[0] + Q_vec[q][3]*fe_values.shape_grad(j, q)[1] + fe_values.shape_value(j, q)*dQ[q][1][0])*fe_values.shape_grad(i, q)[1])
                            ) * fe_values.JxW(q);
                        ...
                        cell_matrix(i, j) += (
                            ...
                            -L2*fe_values.shape_grad(i, q)[0]*fe_values.shape_grad(j, q)[0]
                            +
                            -2*L3*((Q_vec[q][0]*fe_values.shape_grad(j, q)[0] + Q_vec[q][1]*fe_values.shape_grad(j, q)[1])*fe_values.shape_grad(i, q)[0] + (Q_vec[q][1]*fe_values.shape_grad(j, q)[0] + Q_vec[q][3]*fe_values.shape_grad(j, q)[1])*fe_values.shape_grad(i, q)[1])
                            ) * fe_values.JxW(q);
                        ...
                        cell_matrix(i, j) += (
                            ...
                            +
                            L3*(-2*Q_vec[q][0]*fe_values.shape_grad(i, q)[0]*fe_values.shape_grad(j, q)[0] - 2*Q_vec[q][1]*fe_values.shape_grad(i, q)[0]*fe_values.shape_grad(j, q)[1] - 2*Q_vec[q][1]*fe_values.shape_grad(i, q)[1]*fe_values.shape_grad(j, q)[0] - 2*Q_vec[q][3]*fe_values.shape_grad(i, q)[1]*fe_values.shape_grad(j, q)[1] - fe_values.shape_value(j, q)*dQ[q][0][1]*fe_values.shape_grad(i, q)[1] - 2*fe_values.shape_value(j, q)*dQ[q][3][1]*fe_values.shape_grad(i, q)[1])
                            ) * fe_values.JxW(q);
                ...
                if (component_i == 0)
                    cell_rhs(i) -= (
                        ...
                        +
                        -L2*(dQ[q][0][0] + dQ[q][1][1])*fe_values.shape_grad(i, q)[0]
                        +
                    ...
                    cell_rhs(i) -= (
                        ...
                        +
                        -L2*((dQ[q][0][0] + dQ[q][1][1])*fe_values.shape_grad(i, q)[1] + (dQ[q][1][0] + dQ[q][3][1])*fe_values.shape_grad(i, q)[0])
                        +
                        -2*L3*((Q_vec[q][0]*dQ[q][1][0] + Q_vec[q][1]*dQ[q][1][1])*fe_values.shape_grad(i, q)[0] + (Q_vec[q][1]*dQ[q][1][0] + Q_vec[q][3]*dQ[q][1][1])*fe_values.shape_grad(i, q)[1])
                        ) * fe_values.JxW(q);
                    ...
                    cell_rhs(i) -= (
                        ...
                        +
                        -L2*(dQ[q][2][0] + dQ[q][4][1])*fe_values.shape_grad(i, q)[0]
                        +
                        -2*L3*((Q_vec[q][0]*dQ[q][2][0] + Q_vec[q][1]*dQ[q][2][1])*fe_values.shape_grad(i, q)[0] + (Q_vec[q][1]*dQ[q][2][0] + Q_vec[q][3]*dQ[q][2][1])*fe_values.shape_grad(i, q)[1])
                        ) * fe_values.JxW(q);
                    ...
                    cell_rhs(i) -= (
                        ...
                        +
                        -L2*(dQ[q][1][0] + dQ[q][3][1])*fe_values.shape_grad(i, q)[1]
                        +
                    ...
                    cell_rhs(i) -= (
                        ...
                        +
                        -L2*(dQ[q][2][0] + dQ[q][4][1])*fe_values.shape_grad(i, q)[1]
                        +
                        -2*L3*((Q_vec[q][0]*dQ[q][4][0] + Q_vec[q][1]*dQ[q][4][1])*fe_values.shape_grad(i, q)[0] + (Q_vec[q][1]*dQ[q][4][0] + Q_vec[q][3]*dQ[q][4][1])*fe_values.shape_grad(i, q)[1])
                        ) * fe_values.JxW(q);
            }
        }
            ...
            for (unsigned int i = 0; i < dofs_per_cell; ++i)
            {
                ...
                for (unsigned int j = 0; j < dofs_per_cell; ++j)
                {
                    ...
                    if (component_i == 0 && component_j == 0)
                        ...
                        cell_matrix(i, j) += (
                            (-2*dLambda_dQ[0][2] - dLambda_dQ[3][2])*fe_values.shape_value(i, q)*fe_values.shape_value(j, q)
                            +
                            2*L3*(-dQ[q][2][0]*fe_values.shape_grad(j, q)[0] + dQ[q][2][2]*fe_values.shape_grad(j, q)[2])*fe_values.shape_value(i, q)
                            +
                            L2*(-fe_values.shape_grad(i, q)[0]*fe_values.shape_grad(j, q)[2] + fe_values.shape_grad(i, q)[2]*fe_values.shape_grad(j, q)[0])
                            +
                            L3*(-2*dQ[q][0][0]*fe_values.shape_grad(i, q)[2] - 2*dQ[q][0][2]*fe_values.shape_grad(i, q)[0] - dQ[q][3][0]*fe_values.shape_grad(i, q)[2] - dQ[q][3][2]*fe_values.shape_grad(i, q)[0])*fe_values.shape_value(j, q)
                            ) * fe_values.JxW(q);
                    else if (component_i == 0 && component_j == 3)
                        cell_matrix(i, j) += (
                            alpha*fe_values.shape_value(i, q)*fe_values.shape_value(j, q)
                            ...
                            (-2*dLambda_dQ[0][3] - dLambda_dQ[3][3])*fe_values.shape_value(i, q)*fe_values.shape_value(j, q)
                            +
                            L3*(-(dQ[q][0][0] + 2*dQ[q][3][0])*fe_values.shape_grad(j, q)[0] + (dQ[q][0][2] + 2*dQ[q][3][2])*fe_values.shape_grad(j, q)[2])*fe_values.shape_value(i, q)
                            +
                            -fe_values.shape_grad(i, q)[0]*fe_values.shape_grad(j, q)[0] - fe_values.shape_grad(i, q)[1]*fe_values.shape_grad(j, q)[1] - fe_values.shape_grad(i, q)[2]*fe_values.shape_grad(j, q)[2]
                            +
                            -L2*fe_values.shape_grad(i, q)[2]*fe_values.shape_grad(j, q)[2]
                            +
                            -L3*((Q_vec[q][0]*fe_values.shape_grad(j, q)[0] + Q_vec[q][1]*fe_values.shape_grad(j, q)[1] + Q_vec[q][2]*fe_values.shape_grad(j, q)[2])*fe_values.shape_grad(i, q)[0] - ((Q_vec[q][0] + Q_vec[q][3])*fe_values.shape_grad(j, q)[2] + (dQ[q][0][2] + dQ[q][3][2])*fe_values.shape_value(j, q) - Q_vec[q][2]*fe_values.shape_grad(j, q)[0] - Q_vec[q][4]*fe_values.shape_grad(j, q)[1])*fe_values.shape_grad(i, q)[2] + ((dQ[q][0][1] + dQ[q][3][1])*fe_values.shape_value(j, q) + Q_vec[q][1]*fe_values.shape_grad(j, q)[0] + Q_vec[q][3]*fe_values.shape_grad(j, q)[1] + Q_vec[q][4]*fe_values.shape_grad(j, q)[2])*fe_values.shape_grad(i, q)[1] + fe_values.shape_value(j, q)*dQ[q][0][1]*fe_values.shape_grad(i, q)[1] - fe_values.shape_value(j, q)*dQ[q][0][2]*fe_values.shape_grad(i, q)[2])
                            ) * fe_values.JxW(q);
                    else if (component_i == 0 && component_j == 4)
                        cell_matrix(i, j) += (
                            (-2*dLambda_dQ[0][4] - dLambda_dQ[3][4])*fe_values.shape_value(i, q)*fe_values.shape_value(j, q)
                            +
                            2*L3*(-dQ[q][4][0]*fe_values.shape_grad(j, q)[0] + dQ[q][4][2]*fe_values.shape_grad(j, q)[2])*fe_values.shape_value(i, q)
                            +
                            L2*fe_values.shape_grad(i, q)[2]*fe_values.shape_grad(j, q)[1]
                            +
                            L3*(-2*dQ[q][0][1]*fe_values.shape_grad(i, q)[2] - 2*dQ[q][0][2]*fe_values.shape_grad(i, q)[1] - dQ[q][3][1]*fe_values.shape_grad(i, q)[2] - dQ[q][3][2]*fe_values.shape_grad(i, q)[1])*fe_values.shape_value(j, q)
                            ) * fe_values.JxW(q);
                    else if (component_i == 1 && component_j == 0)
                        cell_matrix(i, j) += (
                            -2*dLambda_dQ[1][0]*fe_values.shape_value(i, q)*fe_values.shape_value(j, q)
                            ...
                            -L2*fe_values.shape_grad(i, q)[1]*fe_values.shape_grad(j, q)[0]
                            +
                            2*L3*(-dQ[q][1][0]*fe_values.shape_grad(i, q)[0] + dQ[q][1][2]*fe_values.shape_grad(i, q)[2])*fe_values.shape_value(j, q)
                            ) * fe_values.JxW(q);
                    else if (component_i == 1 && component_j == 1)
                        cell_matrix(i, j) += (
                            2*alpha*fe_values.shape_value(i, q)*fe_values.shape_value(j, q)
                        ...
                        cell_matrix(i, j) += (
                            ...
                            +
                            -2*L3*(dQ[q][1][0]*fe_values.shape_grad(i, q)[2] + dQ[q][1][2]*fe_values.shape_grad(i, q)[0])*fe_values.shape_value(j, q)
                            ) * fe_values.JxW(q);
                    else if (component_i == 1 && component_j == 3)
                        cell_matrix(i, j) += (
                            -2*dLambda_dQ[1][3]*fe_values.shape_value(i, q)*fe_values.shape_value(j, q)
                            ...
                            -L2*fe_values.shape_grad(i, q)[0]*fe_values.shape_grad(j, q)[1]
                            +
                            2*L3*(-dQ[q][1][1]*fe_values.shape_grad(i, q)[1] + dQ[q][1][2]*fe_values.shape_grad(i, q)[2])*fe_values.shape_value(j, q)
                            ) * fe_values.JxW(q);
                    else if (component_i == 1 && component_j == 4)
                        cell_matrix(i, j) += (
                            -2*dLambda_dQ[1][4]*fe_values.shape_value(i, q)*fe_values.shape_value(j, q)
                            ...
                            +
                            -2*L3*(dQ[q][1][1]*fe_values.shape_grad(i, q)[2] + dQ[q][1][2]*fe_values.shape_grad(i, q)[1])*fe_values.shape_value(j, q)
                            ) * fe_values.JxW(q);
                    else if (component_i == 2 && component_j == 0)
                        cell_matrix(i, j) += (
                            -2*dLambda_dQ[2][0]*fe_values.shape_value(i, q)*fe_values.shape_value(j, q)
                            +
                            -L3*((2*dQ[q][0][0] + dQ[q][3][0])*fe_values.shape_grad(j, q)[2] + (2*dQ[q][0][2] + dQ[q][3][2])*fe_values.shape_grad(j, q)[0])*fe_values.shape_value(i, q)
                            +
                            L2*(fe_values.shape_grad(i, q)[0]*fe_values.shape_grad(j, q)[2] - fe_values.shape_grad(i, q)[2]*fe_values.shape_grad(j, q)[0])
                            +
                            2*L3*(-dQ[q][2][0]*fe_values.shape_grad(i, q)[0] + dQ[q][2][2]*fe_values.shape_grad(i, q)[2])*fe_values.shape_value(j, q)
                            ) * fe_values.JxW(q);
                    else if (component_i == 2 && component_j == 1)
                        cell_matrix(i, j) += (
                            -2*dLambda_dQ[2][1]*fe_values.shape_value(i, q)*fe_values.shape_value(j, q)
                            +
                            -2*L3*(dQ[q][1][0]*fe_values.shape_grad(j, q)[2] + dQ[q][1][2]*fe_values.shape_grad(j, q)[0])*fe_values.shape_value(i, q)
                            +
                            -L2*fe_values.shape_grad(i, q)[2]*fe_values.shape_grad(j, q)[1]
                            +
                            -2*L3*(dQ[q][2][0]*fe_values.shape_grad(i, q)[1] + dQ[q][2][1]*fe_values.shape_grad(i, q)[0])*fe_values.shape_value(j, q)
                        ...
                        cell_matrix(i, j) += (
                            ...
                            -2*dLambda_dQ[2][2]*fe_values.shape_value(i, q)*fe_values.shape_value(j, q)
                            +
                            -2*L3*(dQ[q][2][0]*fe_values.shape_grad(j, q)[2] + dQ[q][2][2]*fe_values.shape_grad(j, q)[0])*fe_values.shape_value(i, q)
                            +
                            -2*fe_values.shape_grad(i, q)[0]*fe_values.shape_grad(j, q)[0] - 2*fe_values.shape_grad(i, q)[1]*fe_values.shape_grad(j, q)[1] - 2*fe_values.shape_grad(i, q)[2]*fe_values.shape_grad(j, q)[2]
                            +
                            -L2*(fe_values.shape_grad(i, q)[0]*fe_values.shape_grad(j, q)[0] + fe_values.shape_grad(i, q)[2]*fe_values.shape_grad(j, q)[2])
                            +
                            -2*L3*((Q_vec[q][1]*fe_values.shape_grad(j, q)[0] + Q_vec[q][3]*fe_values.shape_grad(j, q)[1] + Q_vec[q][4]*fe_values.shape_grad(j, q)[2])*fe_values.shape_grad(i, q)[1] + (-(Q_vec[q][0] + Q_vec[q][3])*fe_values.shape_grad(j, q)[2] + Q_vec[q][2]*fe_values.shape_grad(j, q)[0] + Q_vec[q][4]*fe_values.shape_grad(j, q)[1] + fe_values.shape_value(j, q)*dQ[q][2][0])*fe_values.shape_grad(i, q)[2] + (Q_vec[q][0]*fe_values.shape_grad(j, q)[0] + Q_vec[q][1]*fe_values.shape_grad(j, q)[1] + Q_vec[q][2]*fe_values.shape_grad(j, q)[2] + fe_values.shape_value(j, q)*dQ[q][2][2])*fe_values.shape_grad(i, q)[0])
                            ) * fe_values.JxW(q);
                    else if (component_i == 2 && component_j == 3)
                        cell_matrix(i, j) += (
                            -2*dLambda_dQ[2][3]*fe_values.shape_value(i, q)*fe_values.shape_value(j, q)
                            +
                            -L3*((dQ[q][0][0] + 2*dQ[q][3][0])*fe_values.shape_grad(j, q)[2] + (dQ[q][0][2] + 2*dQ[q][3][2])*fe_values.shape_grad(j, q)[0])*fe_values.shape_value(i, q)
                            +
                            L2*fe_values.shape_grad(i, q)[0]*fe_values.shape_grad(j, q)[2]
                            +
                            2*L3*(-dQ[q][2][1]*fe_values.shape_grad(i, q)[1] + dQ[q][2][2]*fe_values.shape_grad(i, q)[2])*fe_values.shape_value(j, q)
                            ) * fe_values.JxW(q);
                    else if (component_i == 2 && component_j == 4)
                        cell_matrix(i, j) += (
                            -2*dLambda_dQ[2][4]*fe_values.shape_value(i, q)*fe_values.shape_value(j, q)
                            +
                            -2*L3*(dQ[q][4][0]*fe_values.shape_grad(j, q)[2] + dQ[q][4][2]*fe_values.shape_grad(j, q)[0])*fe_values.shape_value(i, q)
                            +
                            -L2*fe_values.shape_grad(i, q)[0]*fe_values.shape_grad(j, q)[1]
                            +
                            -2*L3*(dQ[q][2][1]*fe_values.shape_grad(i, q)[2] + dQ[q][2][2]*fe_values.shape_grad(i, q)[1])*fe_values.shape_value(j, q)
                            ) * fe_values.JxW(q);
                    else if (component_i == 3 && component_j == 0)
                        cell_matrix(i, j) += (
                            alpha*fe_values.shape_value(i, q)*fe_values.shape_value(j, q)
                            ...
                            (-dLambda_dQ[0][0] - 2*dLambda_dQ[3][0])*fe_values.shape_value(i, q)*fe_values.shape_value(j, q)
                            +
                            L3*(-(2*dQ[q][0][1] + dQ[q][3][1])*fe_values.shape_grad(j, q)[1] + (2*dQ[q][0][2] + dQ[q][3][2])*fe_values.shape_grad(j, q)[2])*fe_values.shape_value(i, q)
                            +
                            -fe_values.shape_grad(i, q)[0]*fe_values.shape_grad(j, q)[0] - fe_values.shape_grad(i, q)[1]*fe_values.shape_grad(j, q)[1] - fe_values.shape_grad(i, q)[2]*fe_values.shape_grad(j, q)[2]
                            +
                            -L2*fe_values.shape_grad(i, q)[2]*fe_values.shape_grad(j, q)[2]
                            +
                            -L3*((Q_vec[q][1]*fe_values.shape_grad(j, q)[0] + Q_vec[q][3]*fe_values.shape_grad(j, q)[1] + Q_vec[q][4]*fe_values.shape_grad(j, q)[2])*fe_values.shape_grad(i, q)[1] - ((Q_vec[q][0] + Q_vec[q][3])*fe_values.shape_grad(j, q)[2] + (dQ[q][0][2] + dQ[q][3][2])*fe_values.shape_value(j, q) - Q_vec[q][2]*fe_values.shape_grad(j, q)[0] - Q_vec[q][4]*fe_values.shape_grad(j, q)[1])*fe_values.shape_grad(i, q)[2] + ((dQ[q][0][0] + dQ[q][3][0])*fe_values.shape_value(j, q) + Q_vec[q][0]*fe_values.shape_grad(j, q)[0] + Q_vec[q][1]*fe_values.shape_grad(j, q)[1] + Q_vec[q][2]*fe_values.shape_grad(j, q)[2])*fe_values.shape_grad(i, q)[0] + fe_values.shape_value(j, q)*dQ[q][3][0]*fe_values.shape_grad(i, q)[0] - fe_values.shape_value(j, q)*dQ[q][3][2]*fe_values.shape_grad(i, q)[2])
                            ) * fe_values.JxW(q);
                    else if (component_i == 3 && component_j == 1)
                        cell_matrix(i, j) += (
                            (-dLambda_dQ[0][1] - 2*dLambda_dQ[3][1])*fe_values.shape_value(i, q)*fe_values.shape_value(j, q)
                            +
                            2*L3*(-dQ[q][1][1]*fe_values.shape_grad(j, q)[1] + dQ[q][1][2]*fe_values.shape_grad(j, q)[2])*fe_values.shape_value(i, q)
                            +
                            -L2*fe_values.shape_grad(i, q)[1]*fe_values.shape_grad(j, q)[0]
                            +
                            L3*(-dQ[q][0][0]*fe_values.shape_grad(i, q)[1] - dQ[q][0][1]*fe_values.shape_grad(i, q)[0] - 2*dQ[q][3][0]*fe_values.shape_grad(i, q)[1] - 2*dQ[q][3][1]*fe_values.shape_grad(i, q)[0])*fe_values.shape_value(j, q)
                        ...
                        cell_matrix(i, j) += (
                            (-dLambda_dQ[0][2] - 2*dLambda_dQ[3][2])*fe_values.shape_value(i, q)*fe_values.shape_value(j, q)
                            +
                            2*L3*(-dQ[q][2][1]*fe_values.shape_grad(j, q)[1] + dQ[q][2][2]*fe_values.shape_grad(j, q)[2])*fe_values.shape_value(i, q)
                            +
                            L2*fe_values.shape_grad(i, q)[2]*fe_values.shape_grad(j, q)[0]
                            +
                            L3*(-dQ[q][0][0]*fe_values.shape_grad(i, q)[2] - dQ[q][0][2]*fe_values.shape_grad(i, q)[0] - 2*dQ[q][3][0]*fe_values.shape_grad(i, q)[2] - 2*dQ[q][3][2]*fe_values.shape_grad(i, q)[0])*fe_values.shape_value(j, q)
                            ) * fe_values.JxW(q);
                    else if (component_i == 3 && component_j == 3)
                        cell_matrix(i, j) += (
                            2*alpha*fe_values.shape_value(i, q)*fe_values.shape_value(j, q)
                            ...
                            (-dLambda_dQ[0][3] - 2*dLambda_dQ[3][3])*fe_values.shape_value(i, q)*fe_values.shape_value(j, q)
                            +
                            L3*(-(dQ[q][0][1] + 2*dQ[q][3][1])*fe_values.shape_grad(j, q)[1] + (dQ[q][0][2] + 2*dQ[q][3][2])*fe_values.shape_grad(j, q)[2])*fe_values.shape_value(i, q)
                            +
                            -2*fe_values.shape_grad(i, q)[0]*fe_values.shape_grad(j, q)[0] - 2*fe_values.shape_grad(i, q)[1]*fe_values.shape_grad(j, q)[1] - 2*fe_values.shape_grad(i, q)[2]*fe_values.shape_grad(j, q)[2]
                            +
                            -L2*(fe_values.shape_grad(i, q)[1]*fe_values.shape_grad(j, q)[1] + fe_values.shape_grad(i, q)[2]*fe_values.shape_grad(j, q)[2])
                            +
                        ...
                        cell_matrix(i, j) += (
                            (-dLambda_dQ[0][4] - 2*dLambda_dQ[3][4])*fe_values.shape_value(i, q)*fe_values.shape_value(j, q)
                            +
                            2*L3*(-dQ[q][4][1]*fe_values.shape_grad(j, q)[1] + dQ[q][4][2]*fe_values.shape_grad(j, q)[2])*fe_values.shape_value(i, q)
                            +
                            L2*(-fe_values.shape_grad(i, q)[1]*fe_values.shape_grad(j, q)[2] + fe_values.shape_grad(i, q)[2]*fe_values.shape_grad(j, q)[1])
                            +
                            L3*(-dQ[q][0][1]*fe_values.shape_grad(i, q)[2] - dQ[q][0][2]*fe_values.shape_grad(i, q)[1] - 2*dQ[q][3][1]*fe_values.shape_grad(i, q)[2] - 2*dQ[q][3][2]*fe_values.shape_grad(i, q)[1])*fe_values.shape_value(j, q)
                            ) * fe_values.JxW(q);
                    else if (component_i == 4 && component_j == 0)
                        cell_matrix(i, j) += (
                            -2*dLambda_dQ[4][0]*fe_values.shape_value(i, q)*fe_values.shape_value(j, q)
                            +
                            -L3*((2*dQ[q][0][1] + dQ[q][3][1])*fe_values.shape_grad(j, q)[2] + (2*dQ[q][0][2] + dQ[q][3][2])*fe_values.shape_grad(j, q)[1])*fe_values.shape_value(i, q)
                            +
                            L2*fe_values.shape_grad(i, q)[1]*fe_values.shape_grad(j, q)[2]
                            +
                            2*L3*(-dQ[q][4][0]*fe_values.shape_grad(i, q)[0] + dQ[q][4][2]*fe_values.shape_grad(i, q)[2])*fe_values.shape_value(j, q)
                            ) * fe_values.JxW(q);
                    else if (component_i == 4 && component_j == 1)
                        cell_matrix(i, j) += (
                            -2*dLambda_dQ[4][1]*fe_values.shape_value(i, q)*fe_values.shape_value(j, q)
                            +
                            -2*L3*(dQ[q][1][1]*fe_values.shape_grad(j, q)[2] + dQ[q][1][2]*fe_values.shape_grad(j, q)[1])*fe_values.shape_value(i, q)
                            +
                            -L2*fe_values.shape_grad(i, q)[2]*fe_values.shape_grad(j, q)[0]
                            +
                            -2*L3*(dQ[q][4][0]*fe_values.shape_grad(i, q)[1] + dQ[q][4][1]*fe_values.shape_grad(i, q)[0])*fe_values.shape_value(j, q)
                        ...
                        cell_matrix(i, j) += (
                            -2*dLambda_dQ[4][2]*fe_values.shape_value(i, q)*fe_values.shape_value(j, q)
                            +
                            -2*L3*(dQ[q][2][1]*fe_values.shape_grad(j, q)[2] + dQ[q][2][2]*fe_values.shape_grad(j, q)[1])*fe_values.shape_value(i, q)
                            +
                            -L2*fe_values.shape_grad(i, q)[1]*fe_values.shape_grad(j, q)[0]
                            +
                            -2*L3*(dQ[q][4][0]*fe_values.shape_grad(i, q)[2] + dQ[q][4][2]*fe_values.shape_grad(i, q)[0])*fe_values.shape_value(j, q)
                            ) * fe_values.JxW(q);
                    else if (component_i == 4 && component_j == 3)
                        cell_matrix(i, j) += (
                            -2*dLambda_dQ[4][3]*fe_values.shape_value(i, q)*fe_values.shape_value(j, q)
                            +
                            -L3*((dQ[q][0][1] + 2*dQ[q][3][1])*fe_values.shape_grad(j, q)[2] + (dQ[q][0][2] + 2*dQ[q][3][2])*fe_values.shape_grad(j, q)[1])*fe_values.shape_value(i, q)
                            +
                            L2*(fe_values.shape_grad(i, q)[1]*fe_values.shape_grad(j, q)[2] - fe_values.shape_grad(i, q)[2]*fe_values.shape_grad(j, q)[1])
                            +
                            2*L3*(-dQ[q][4][1]*fe_values.shape_grad(i, q)[1] + dQ[q][4][2]*fe_values.shape_grad(i, q)[2])*fe_values.shape_value(j, q)
                            ) * fe_values.JxW(q);
                    else if (component_i == 4 && component_j == 4)
                        cell_matrix(i, j) += (
                            2*alpha*fe_values.shape_value(i, q)*fe_values.shape_value(j, q)
                ...
                if (component_i == 0)
                    cell_rhs(i) -= (
                        ...
                        (-2*Lambda_vec[0] - Lambda_vec[3])*fe_values.shape_value(i, q)
                        +
                        L3*(-(dQ[q][0][0]) * (dQ[q][0][0]) - dQ[q][0][0]*dQ[q][3][0] + (dQ[q][0][2]) * (dQ[q][0][2]) + dQ[q][0][2]*dQ[q][3][2] - (dQ[q][1][0]) * (dQ[q][1][0]) + (dQ[q][1][2]) * (dQ[q][1][2]) - (dQ[q][2][0]) * (dQ[q][2][0]) + (dQ[q][2][2]) * (dQ[q][2][2]) - (dQ[q][3][0]) * (dQ[q][3][0]) + (dQ[q][3][2]) * (dQ[q][3][2]) - (dQ[q][4][0]) * (dQ[q][4][0]) + (dQ[q][4][2]) * (dQ[q][4][2]))*fe_values.shape_value(i, q)
                        +
                        -2*dQ[q][0][0]*fe_values.shape_grad(i, q)[0] - 2*dQ[q][0][1]*fe_values.shape_grad(i, q)[1] - 2*dQ[q][0][2]*fe_values.shape_grad(i, q)[2] - dQ[q][3][0]*fe_values.shape_grad(i, q)[0] - dQ[q][3][1]*fe_values.shape_grad(i, q)[1] - dQ[q][3][2]*fe_values.shape_grad(i, q)[2]
                        +
                        -L2*((dQ[q][0][0] + dQ[q][1][1] + dQ[q][2][2])*fe_values.shape_grad(i, q)[0] + (dQ[q][0][2] - dQ[q][2][0] + dQ[q][3][2] - dQ[q][4][1])*fe_values.shape_grad(i, q)[2])
                        +
                        L3*(-(-(Q_vec[q][0] + Q_vec[q][3])*(dQ[q][0][2] + dQ[q][3][2]) + (dQ[q][0][0] + dQ[q][3][0])*Q_vec[q][2] + (dQ[q][0][1] + dQ[q][3][1])*Q_vec[q][4])*fe_values.shape_grad(i, q)[2] - (-(Q_vec[q][0] + Q_vec[q][3])*dQ[q][0][2] + Q_vec[q][2]*dQ[q][0][0] + Q_vec[q][4]*dQ[q][0][1])*fe_values.shape_grad(i, q)[2] - ((dQ[q][0][0] + dQ[q][3][0])*Q_vec[q][0] + (dQ[q][0][1] + dQ[q][3][1])*Q_vec[q][1] + (dQ[q][0][2] + dQ[q][3][2])*Q_vec[q][2])*fe_values.shape_grad(i, q)[0] - ((dQ[q][0][0] + dQ[q][3][0])*Q_vec[q][1] + (dQ[q][0][1] + dQ[q][3][1])*Q_vec[q][3] + (dQ[q][0][2] + dQ[q][3][2])*Q_vec[q][4])*fe_values.shape_grad(i, q)[1] - (Q_vec[q][0]*dQ[q][0][0] + Q_vec[q][1]*dQ[q][0][1] + Q_vec[q][2]*dQ[q][0][2])*fe_values.shape_grad(i, q)[0] - (Q_vec[q][1]*dQ[q][0][0] + Q_vec[q][3]*dQ[q][0][1] + Q_vec[q][4]*dQ[q][0][2])*fe_values.shape_grad(i, q)[1])
                        ) * fe_values.JxW(q);
                else if (component_i == 1)
                    cell_rhs(i) -= (
                        2*alpha*Q_vec[q][1]*fe_values.shape_value(i, q)
                        ...
                        -L3*((dQ[q][0][0] + dQ[q][3][0])*(dQ[q][0][1] + dQ[q][3][1]) + dQ[q][0][0]*dQ[q][0][1] + 2*dQ[q][1][0]*dQ[q][1][1] + 2*dQ[q][2][0]*dQ[q][2][1] + dQ[q][3][0]*dQ[q][3][1] + 2*dQ[q][4][0]*dQ[q][4][1])*fe_values.shape_value(i, q)
                        +
                        -2*dQ[q][1][0]*fe_values.shape_grad(i, q)[0] - 2*dQ[q][1][1]*fe_values.shape_grad(i, q)[1] - 2*dQ[q][1][2]*fe_values.shape_grad(i, q)[2]
                        +
                        -L2*((dQ[q][0][0] + dQ[q][1][1] + dQ[q][2][2])*fe_values.shape_grad(i, q)[1] + (dQ[q][1][0] + dQ[q][3][1] + dQ[q][4][2])*fe_values.shape_grad(i, q)[0])
                        +
                        -2*L3*((-(Q_vec[q][0] + Q_vec[q][3])*dQ[q][1][2] + Q_vec[q][2]*dQ[q][1][0] + Q_vec[q][4]*dQ[q][1][1])*fe_values.shape_grad(i, q)[2] + (Q_vec[q][0]*dQ[q][1][0] + Q_vec[q][1]*dQ[q][1][1] + Q_vec[q][2]*dQ[q][1][2])*fe_values.shape_grad(i, q)[0] + (Q_vec[q][1]*dQ[q][1][0] + Q_vec[q][3]*dQ[q][1][1] + Q_vec[q][4]*dQ[q][1][2])*fe_values.shape_grad(i, q)[1])
                        ) * fe_values.JxW(q);
                else if (component_i == 2)
                    cell_rhs(i) -= (
                        2*alpha*Q_vec[q][2]*fe_values.shape_value(i, q)
                        ...
                        -2*Lambda_vec[2]*fe_values.shape_value(i, q)
                        +
                        -L3*((dQ[q][0][0] + dQ[q][3][0])*(dQ[q][0][2] + dQ[q][3][2]) + dQ[q][0][0]*dQ[q][0][2] + 2*dQ[q][1][0]*dQ[q][1][2] + 2*dQ[q][2][0]*dQ[q][2][2] + dQ[q][3][0]*dQ[q][3][2] + 2*dQ[q][4][0]*dQ[q][4][2])*fe_values.shape_value(i, q)
                        +
                        -2*dQ[q][2][0]*fe_values.shape_grad(i, q)[0] - 2*dQ[q][2][1]*fe_values.shape_grad(i, q)[1] - 2*dQ[q][2][2]*fe_values.shape_grad(i, q)[2]
                        +
                        -L2*((dQ[q][0][0] + dQ[q][1][1] + dQ[q][2][2])*fe_values.shape_grad(i, q)[2] - (dQ[q][0][2] - dQ[q][2][0] + dQ[q][3][2] - dQ[q][4][1])*fe_values.shape_grad(i, q)[0])
                        +
                        -2*L3*((-(Q_vec[q][0] + Q_vec[q][3])*dQ[q][2][2] + Q_vec[q][2]*dQ[q][2][0] + Q_vec[q][4]*dQ[q][2][1])*fe_values.shape_grad(i, q)[2] + (Q_vec[q][0]*dQ[q][2][0] + Q_vec[q][1]*dQ[q][2][1] + Q_vec[q][2]*dQ[q][2][2])*fe_values.shape_grad(i, q)[0] + (Q_vec[q][1]*dQ[q][2][0] + Q_vec[q][3]*dQ[q][2][1] + Q_vec[q][4]*dQ[q][2][2])*fe_values.shape_grad(i, q)[1])
                        ) * fe_values.JxW(q);
                else if (component_i == 3)
                    cell_rhs(i) -= (
                        alpha*(Q_vec[q][0] + 2*Q_vec[q][3])*fe_values.shape_value(i, q)
                        ...
                        (-Lambda_vec[0] - 2*Lambda_vec[3])*fe_values.shape_value(i, q)
                        +
                        L3*(-(dQ[q][0][1]) * (dQ[q][0][1]) - dQ[q][0][1]*dQ[q][3][1] + (dQ[q][0][2]) * (dQ[q][0][2]) + dQ[q][0][2]*dQ[q][3][2] - (dQ[q][1][1]) * (dQ[q][1][1]) + (dQ[q][1][2]) * (dQ[q][1][2]) - (dQ[q][2][1]) * (dQ[q][2][1]) + (dQ[q][2][2]) * (dQ[q][2][2]) - (dQ[q][3][1]) * (dQ[q][3][1]) + (dQ[q][3][2]) * (dQ[q][3][2]) - (dQ[q][4][1]) * (dQ[q][4][1]) + (dQ[q][4][2]) * (dQ[q][4][2]))*fe_values.shape_value(i, q)
                        +
                        -dQ[q][0][0]*fe_values.shape_grad(i, q)[0] - dQ[q][0][1]*fe_values.shape_grad(i, q)[1] - dQ[q][0][2]*fe_values.shape_grad(i, q)[2] - 2*dQ[q][3][0]*fe_values.shape_grad(i, q)[0] - 2*dQ[q][3][1]*fe_values.shape_grad(i, q)[1] - 2*dQ[q][3][2]*fe_values.shape_grad(i, q)[2]
                        +
                        -L2*((dQ[q][1][0] + dQ[q][3][1] + dQ[q][4][2])*fe_values.shape_grad(i, q)[1] + (dQ[q][0][2] - dQ[q][2][0] + dQ[q][3][2] - dQ[q][4][1])*fe_values.shape_grad(i, q)[2])
                        +
                    ...
                    cell_rhs(i) -= (
                        ...
                        -2*Lambda_vec[4]*fe_values.shape_value(i, q)
                        +
                        -L3*((dQ[q][0][1] + dQ[q][3][1])*(dQ[q][0][2] + dQ[q][3][2]) + dQ[q][0][1]*dQ[q][0][2] + 2*dQ[q][1][1]*dQ[q][1][2] + 2*dQ[q][2][1]*dQ[q][2][2] + dQ[q][3][1]*dQ[q][3][2] + 2*dQ[q][4][1]*dQ[q][4][2])*fe_values.shape_value(i, q)
                        +
                        -2*dQ[q][4][0]*fe_values.shape_grad(i, q)[0] - 2*dQ[q][4][1]*fe_values.shape_grad(i, q)[1] - 2*dQ[q][4][2]*fe_values.shape_grad(i, q)[2]
                        +
                        -L2*((dQ[q][1][0] + dQ[q][3][1] + dQ[q][4][2])*fe_values.shape_grad(i, q)[2] - (dQ[q][0][2] - dQ[q][2][0] + dQ[q][3][2] - dQ[q][4][1])*fe_values.shape_grad(i, q)[1])
                        +
                        -2*L3*((-(Q_vec[q][0] + Q_vec[q][3])*dQ[q][4][2] + Q_vec[q][2]*dQ[q][4][0] + Q_vec[q][4]*dQ[q][4][1])*fe_values.shape_grad(i, q)[2] + (Q_vec[q][0]*dQ[q][4][0] + Q_vec[q][1]*dQ[q][4][1] + Q_vec[q][2]*dQ[q][4][2])*fe_values.shape_grad(i, q)[0] + (Q_vec[q][1]*dQ[q][4][0] + Q_vec[q][3]*dQ[q][4][1] + Q_vec[q][4]*dQ[q][4][2])*fe_values.shape_grad(i, q)[1])
                        ) * fe_values.JxW(q);
            }
        }
        constraints.distribute_local_to_global(cell_matrix,
